<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FRM100.aspx.cs" Inherits="Sigesoft.Server.WebClientAdmin.UI.CargaData.FRM100" %>
...
<body>
    <form id="form1" runat="server">
       <x:Pagemanager ID="PageManager1" runat="server" AutoSizePanelID="Panel1"/>
        ...
        <Items>
             <x:GroupPanel runat="server" Title="Datos de Agendado Masivo" ID="GroupPanel1" AutoWidth="true" BoxFlex="1" Height="90" >                
                <Items>
                        ...
                        <Items>                             
                            <x:Panel ID="Panel133" ShowHeader="false" CssClass="x-form-item" ShowBorder="false" EnableBackgroundColor="true" Layout="Column"  runat="server">
                                <Items>
                                    ...
                                    <x:DropDownList ID="ddlEmpresaCliente" runat="server" ShowLabel="false" Width="250" OnSelectedIndexChanged="ddlEmpresaCliente_SelectedIndexChanged" AutoPostBack="true"></x:DropDownList> 
                    ...
                    <x:Toolbar ID="Toolbar1" runat="server">
                        <Items>
                              <x:FileUpload runat="server" ID="fileDoc" EmptyText="Por favor seleccione un archivo" Width="300" Height="25"
                                        Label="Seleccionar Excel" ButtonIcon="SystemSearch" OnFileSelected="fileDoc_FileSelected" AutoPostBack="true" ButtonText="Seleccionar" Readonly="False"  Enabled="false">
                                </x:FileUpload>
    ...
    <x:Window ID="winEdit" Title="Nueva Agenda Personal" Popup="false" EnableIFrame="true" runat="server" Icon="UserBrown"
        ...
        Target="Top" OnClose="winEdit_Close" IsModal="True" Width="450px" Height="300px" >
    </x:Window>
