<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FRMReagenda.aspx.cs" Inherits="Sigesoft.Server.WebClientAdmin.UI.ExternalUser.FRMReagenda" %>
                 ...
                 <x:Panel ID="Panel4" Layout="Fit" runat="server" ShowBorder="false" ShowHeader="false" >
                    <Items>
                        ...
                        AutoScroll="true" runat="server" EnableCollapse="True" Height="180px" >                        
                            <Items>     
                              <x:DatePicker ID="dpFecha" Label="Fecha agenda" Width="120px" runat="server" DateFormatString="dd/MM/yyyy" />
                            </Items>
                        </x:SimpleForm>
                    </Items>
                </x:Panel>
