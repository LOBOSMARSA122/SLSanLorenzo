<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FRM033E.aspx.cs" Inherits="Sigesoft.Server.WebClientAdmin.UI.Auditar.FRM033E" %>
                    ...
                    <Items>
                        ...
                        AutoScroll="true" runat="server" EnableCollapse="True" Height="330px" >                        
                            <Items>   
                                    ...
                                    <x:DropDownList ID="ddlRecomendaciones" runat="server"  Label="Restricción"  AutoPostBack="true" OnSelectedIndexChanged="ddlRecomendaciones_SelectedIndexChanged" ></x:DropDownList>        
                                   ...
                                   <x:GroupPanel runat="server" Title="Crear Nueva Recomendación" ID="GroupPanel1" Width="560px" AutoWidth="true" BoxFlex="1" Height="90" > 
                                        <Items>
                                             ...
                                             <x:Button ID="btnGrabar" Text="Guardar nueva Restricción" Icon="Find" IconAlign="Left" runat="server" AjaxLoadingType="Mask" CssClass="inline"  ValidateForms="Form2" OnClick="btnGrabar_Click" ></x:Button>                                       
                                        </Items>                  
                                    </x:GroupPanel>
                            </Items>
                        </x:SimpleForm>
