...
namespace NetPdf
{
    public class AccidentesTrabajo_F1
    {
            ...
            string filePDF, UsuarioGrabo usuariograbo)
        {
            ...
            Font fontTitle1_1 = FontFactory.GetFont("Calibri", 12, iTextSharp.text.Font.BOLD, new BaseColor(System.Drawing.Color.White));
            Font fontTitle2_2 = FontFactory.GetFont("Calibri", 7, iTextSharp.text.Font.NORMAL, new BaseColor(System.Drawing.Color.White));
            ...
            Font fontColumnValue_1 = FontFactory.GetFont("Calibri", 7, iTextSharp.text.Font.NORMAL, new BaseColor(System.Drawing.Color.White));
            Font fontColumnValueBold_1 = FontFactory.GetFont("Calibri", 7, iTextSharp.text.Font.BOLD, new BaseColor(System.Drawing.Color.White));
            Font fontColumnValueApendice_1 = FontFactory.GetFont("Calibri", 5, iTextSharp.text.Font.BOLD, new BaseColor(System.Drawing.Color.White));
            #endregion
            ...
            var cellsTit = new List<PdfPCell>()
                { 
                    new PdfPCell(new Phrase("FORMULARIO N° 1", fontTitle1_1)) { BackgroundColor= BaseColor.ORANGE, HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 18f, BorderColor = BaseColor.WHITE},
                
                    new PdfPCell(new Phrase("", fontTitle1_1)) { BackgroundColor= BaseColor.ORANGE, HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 10f, BorderColor = BaseColor.WHITE},

                    new PdfPCell(new Phrase("NOTIFICACIÓN DE LOS ACCIDENTES DE TRABAJO MORTALES E INCIDENTES PELIGROSOS", fontTitle1_1)) { BackgroundColor= BaseColor.ORANGE, HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 18f, BorderColor = BaseColor.WHITE},

                    new PdfPCell(new Phrase("(Artículos 112, 113 y 114 del Reglamento de la Ley Nº 29783, Ley de Seguridad y Salud en el Trabajo)", fontTitle1)) { BackgroundColor= BaseColor.ORANGE, HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 13f, BorderColor = BaseColor.WHITE},
            ...
            ServiceComponentList ficha1 = serviceComponent.Find(p => p.v_ComponentId == Sigesoft.Common.Constants.ACCIDENTES_DE_TRABAJO_F1);
            var año = ficha1.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.F1_I_AÑO) == null ? "" : ficha1.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.F1_I_AÑO).v_Value1;
            var mes = ficha1.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.F1_I_MES) == null ? "" : ficha1.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.F1_I_MES).v_Value1;

            var aviso_accidente_mortal = ficha1.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.F1_I_ACCIDENTE_NO_MORTAL) == null ? "" : ficha1.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.F1_I_ACCIDENTE_NO_MORTAL).v_Value1;
            string aviso_accidente_mortal_1 = "";
            if (aviso_accidente_mortal == "1")
                aviso_accidente_mortal_1 = " X ";
            else
                aviso_accidente_mortal_1 = " X ";

            var aviso_incidente_peligroso = ficha1.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.F1_I_INCIDENTE_PELIGROSO) == null ? "" : ficha1.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.F1_I_INCIDENTE_PELIGROSO).v_Value1;
            string aviso_incidente_peligroso_1 = "";
            if (aviso_incidente_peligroso == "1")
                aviso_incidente_peligroso_1 = " X ";
            else
                aviso_incidente_peligroso_1 = " X ";
