...
namespace NetPdf
{
    public class ExoneracionEspirometria
    {
        ...
        public static void CreateExoneracionEspirometria(ServiceList DataService, string filePDF,
            ...
            List<ServiceComponentList> serviceComponent)
        {
            ...
            var cellsTit = new List<PdfPCell>()
                { 
                    new PdfPCell(new Phrase("EXONERACIÓN DE EXAMEN DE ESPIROMETRIA", fontTitle1)) {HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 30f, BorderColor=BaseColor.WHITE },
                };
            ...
            #region Contenido
            ServiceComponentList exoneracion_espirometria = serviceComponent.Find(p => p.v_ComponentId == Sigesoft.Common.Constants.EXCEPCIONES_ESPIROMETRIA_ID);
            var motivo = exoneracion_espirometria.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXCEPCIONES_ESPIROMETRIA_MOTIVO) == null ? "" : exoneracion_espirometria.ServiceComponentFields.Find(p => p.v_ComponentFieldsId == Sigesoft.Common.Constants.EXCEPCIONES_ESPIROMETRIA_MOTIVO).v_Value1;
            ...
            {          
                ...
                new PdfPCell(new Phrase("del procedimiento de Espirometría por motivos de: ", fontColumnValue)) 
