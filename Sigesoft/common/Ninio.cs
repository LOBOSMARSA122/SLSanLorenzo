    ...
    public class Ninio
    {
             ...
             List<frmEsoCuidadosPreventivosComentarios> ComentariosCP)
        {
            ...
            {          
                ...
                new PdfPCell(new Phrase("Problemas y Necesidades", fontColumnValue)) { Colspan = 20, HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, BackgroundColor= BaseColor.ORANGE,FixedHeight = 15f},    
            ...
            cells = new List<PdfPCell>()
                {
                new PdfPCell(new Phrase("ATENCIONES", fontColumnValue)) { Colspan = 28, HorizontalAlignment = PdfPCell.ALIGN_CENTER , BackgroundColor=BaseColor.ORANGE},    

                new PdfPCell(new Phrase("N°", fontColumnValue)) { Colspan = 1, Rowspan=2,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, BackgroundColor=BaseColor.GRAY},    
                new PdfPCell(new Phrase("PRESTACIONES DE SALUD", fontColumnValue)) { Colspan = 7,Rowspan=2, HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, BackgroundColor=BaseColor.GRAY},    
                new PdfPCell(new Phrase("FECHAS", fontColumnValue)) { Colspan = 16, HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE , BackgroundColor=BaseColor.GRAY},
                new PdfPCell(new Phrase("COMENTARIOS", fontColumnValue)) { Colspan = 4,Rowspan=2, HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, BackgroundColor=BaseColor.GRAY},
                
                new PdfPCell(new Phrase(FechasCP.Count < 1 ? "" : FechasCP[0].FechaServicio.ToShortDateString(), fontColumnValue)) {Colspan = 2, HorizontalAlignment = PdfPCell.ALIGN_CENTER },               
                new PdfPCell(new Phrase(FechasCP.Count < 2 ? "" : FechasCP[1].FechaServicio.ToShortDateString(), fontColumnValue)) {Colspan = 2, HorizontalAlignment = PdfPCell.ALIGN_CENTER }, 
                new PdfPCell(new Phrase(FechasCP.Count < 3 ? "" : FechasCP[2].FechaServicio.ToShortDateString(), fontColumnValue)) {Colspan = 2, HorizontalAlignment = PdfPCell.ALIGN_CENTER },               
                new PdfPCell(new Phrase(FechasCP.Count < 4 ? "" : FechasCP[3].FechaServicio.ToShortDateString(), fontColumnValue)) {Colspan = 2, HorizontalAlignment = PdfPCell.ALIGN_CENTER }, 
                new PdfPCell(new Phrase(FechasCP.Count < 5 ? "" : FechasCP[4].FechaServicio.ToShortDateString(), fontColumnValue)) {Colspan = 2, HorizontalAlignment = PdfPCell.ALIGN_CENTER },               
                new PdfPCell(new Phrase(FechasCP.Count < 6 ? "" : FechasCP[5].FechaServicio.ToShortDateString(), fontColumnValue)) {Colspan = 2, HorizontalAlignment = PdfPCell.ALIGN_CENTER },     
                new PdfPCell(new Phrase(FechasCP.Count < 7 ? "" : FechasCP[6].FechaServicio.ToShortDateString(), fontColumnValue)) {Colspan = 2, HorizontalAlignment = PdfPCell.ALIGN_CENTER },
                new PdfPCell(new Phrase(FechasCP.Count < 8 ? "" : FechasCP[7].FechaServicio.ToShortDateString(), fontColumnValue)) {Colspan = 2, HorizontalAlignment = PdfPCell.ALIGN_CENTER },

                new PdfPCell(new Phrase("1", fontColumnValue)) { Colspan = 1,HorizontalAlignment = PdfPCell.ALIGN_CENTER, FixedHeight = 15f},
                new PdfPCell(new Phrase("Atenciones del recién nacido", fontColumnValue)) { Colspan = 7,HorizontalAlignment = PdfPCell.ALIGN_LEFT, FixedHeight = 15f},
                new PdfPCell(new Phrase(FechasCP.Count < 1 ? "" : FechasCP[0].Listado == null ? "" : FechasCP[0].Listado.Where(x => x.Nombre == "CONTROL").FirstOrDefault().Hijos == null ? "" : FechasCP[0].Listado.Where(x => x.Nombre == "CONTROL").FirstOrDefault().Hijos.Where(x => x.Nombre == "ATENCIÓN DEL RECIÉN NACIDO").FirstOrDefault() == null ? "" : FechasCP[0].Listado.Where(x => x.Nombre == "CONTROL").FirstOrDefault().Hijos.Where(x => x.Nombre == "ATENCIÓN DEL RECIÉN NACIDO").FirstOrDefault().Valor ? "X" : "", fontColumnValue)) { Colspan =2, HorizontalAlignment = PdfPCell.ALIGN_CENTER, FixedHeight = 15f },               
                ...
                new PdfPCell(new Phrase(ComentariosCP.Where(x => x.GrupoId == FechasCP[0].Listado.Where(z => z.Nombre == "CONTROL").FirstOrDefault().Hijos.Where(y => y.Nombre == "ATENCIÓN DEL RECIÉN NACIDO").FirstOrDefault().GrupoId && x.ParametroId == FechasCP[0].Listado.Where(z => z.Nombre == "CONTROL").FirstOrDefault().Hijos.Where(y => y.Nombre == "ATENCIÓN DEL RECIÉN NACIDO").FirstOrDefault().ParameterId).FirstOrDefault().Comentario, fontColumnValue)) {Colspan =4,HorizontalAlignment = PdfPCell.ALIGN_LEFT, FixedHeight = 15f }, 

                new PdfPCell(new Phrase("2", fontColumnValue)) { Colspan = 1,HorizontalAlignment = PdfPCell.ALIGN_CENTER },
                new PdfPCell(new Phrase("Control de Crecimiento y Desarrollo del Niño", fontColumnValue)) { Colspan = 7,HorizontalAlignment = PdfPCell.ALIGN_LEFT },
                ...
                new PdfPCell(new Phrase(ComentariosCP.Where(x => x.GrupoId == FechasCP[0].Listado.Where(z => z.Nombre == "CONTROL").FirstOrDefault().Hijos.Where(y => y.Nombre == "CONTROL DE CRECIMIENTO Y DESARROLLO").FirstOrDefault().GrupoId && x.ParametroId == FechasCP[0].Listado.Where(z => z.Nombre == "CONTROL").FirstOrDefault().Hijos.Where(y => y.Nombre == "CONTROL DE CRECIMIENTO Y DESARROLLO").FirstOrDefault().ParameterId).FirstOrDefault().Comentario, fontColumnValue)) {Colspan =4,HorizontalAlignment = PdfPCell.ALIGN_LEFT }, 

                new PdfPCell(new Phrase("3", fontColumnValue)) { Colspan = 1, Rowspan=3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE },
                new PdfPCell(new Phrase("Administración de Micro nutrientes", fontColumnValue)) { Colspan = 4, Rowspan=3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE },
                new PdfPCell(new Phrase("Hierro", fontColumnValue)) { Colspan = 3,HorizontalAlignment = PdfPCell.ALIGN_LEFT },
                ...
                new PdfPCell(new Phrase("Vitamina A", fontColumnValue)) { Colspan = 3,HorizontalAlignment = PdfPCell.ALIGN_LEFT },
                new PdfPCell(new Phrase(FechasCP.Count < 1 ? "" : 
                FechasCP[0].Listado == null ? "" : 
                FechasCP[0].Listado.Where(x => x.Nombre == "ALIMENTACIÓN").FirstOrDefault().Hijos == null ? "" : 
                FechasCP[0].Listado.Where(x => x.Nombre == "ALIMENTACIÓN").FirstOrDefault().Hijos.Where(x => x.Nombre == "ADMINISTRACIÓN DE MICRO NUTRIENTES").FirstOrDefault() == null ? "" : 
                ...
                new PdfPCell(new Phrase(ComentariosCP.Where(x => x.GrupoId == FechasCP[0].Listado.Where(z => z.Nombre == "SESIONES").FirstOrDefault().Hijos.Where(y => y.Nombre == "SESIÓN DE ESTIMULACIÓN TEMPRANA").FirstOrDefault().GrupoId && x.ParametroId == FechasCP[0].Listado.Where(z => z.Nombre == "SESIONES").FirstOrDefault().Hijos.Where(y => y.Nombre == "SESIÓN DE ESTIMULACIÓN TEMPRANA").FirstOrDefault().ParameterId).FirstOrDefault().Comentario, fontColumnValue)) {Colspan =4,HorizontalAlignment = PdfPCell.ALIGN_LEFT }, 

                new PdfPCell(new Phrase("5", fontColumnValue)) { Colspan = 1,HorizontalAlignment = PdfPCell.ALIGN_CENTER },
                new PdfPCell(new Phrase("Consejería Nutricional", fontColumnValue)) { Colspan = 7,HorizontalAlignment = PdfPCell.ALIGN_LEFT },
                new PdfPCell(new Phrase(FechasCP.Count < 1 ? "" : FechasCP[0].Listado == null ? "" : FechasCP[0].Listado.Where(x => x.Nombre == "ALIMENTACIÓN").FirstOrDefault().Hijos == null ? "" : FechasCP[0].Listado.Where(x => x.Nombre == "ALIMENTACIÓN").FirstOrDefault().Hijos.Where(x => x.Nombre == "CONSEJERÍA NUTRICIONAL").FirstOrDefault() == null ? "" : FechasCP[0].Listado.Where(x => x.Nombre == "ALIMENTACIÓN").FirstOrDefault().Hijos.Where(x => x.Nombre == "CONSEJERÍA NUTRICIONAL").FirstOrDefault().Valor ? "X" : "", fontColumnValue)) { Colspan =2, HorizontalAlignment = PdfPCell.ALIGN_CENTER },               
                ...
                new PdfPCell(new Phrase(ComentariosCP.Where(x => x.GrupoId == FechasCP[0].Listado.Where(z => z.Nombre == "ALIMENTACIÓN").FirstOrDefault().Hijos.Where(y => y.Nombre == "CONSEJERÍA NUTRICIONAL").FirstOrDefault().GrupoId && x.ParametroId == FechasCP[0].Listado.Where(z => z.Nombre == "ALIMENTACIÓN").FirstOrDefault().Hijos.Where(y => y.Nombre == "CONSEJERÍA NUTRICIONAL").FirstOrDefault().ParameterId).FirstOrDefault().Comentario, fontColumnValue)) {Colspan =4,HorizontalAlignment = PdfPCell.ALIGN_LEFT }, 

                new PdfPCell(new Phrase("6", fontColumnValue)) { Colspan = 1,HorizontalAlignment = PdfPCell.ALIGN_CENTER },
                new PdfPCell(new Phrase("Administración de vacuna", fontColumnValue)) { Colspan = 7,HorizontalAlignment = PdfPCell.ALIGN_LEFT },
                new PdfPCell(new Phrase(FechasCP.Count < 1 ? "" : FechasCP[0].Listado == null ? "" : FechasCP[0].Listado.Where(x => x.Nombre == "VACUNA").FirstOrDefault().Hijos == null ? "" : FechasCP[0].Listado.Where(x => x.Nombre == "VACUNA").FirstOrDefault().Hijos.Where(x => x.Nombre == "ADMINISTRACIÓN DE VACUNA").FirstOrDefault() == null ? "" : FechasCP[0].Listado.Where(x => x.Nombre == "VACUNA").FirstOrDefault().Hijos.Where(x => x.Nombre == "ADMINISTRACIÓN DE VACUNA").FirstOrDefault().Valor ? "X" : "", fontColumnValue)) { Colspan =2, HorizontalAlignment = PdfPCell.ALIGN_CENTER },               
                ...
                new PdfPCell(new Phrase(ComentariosCP.Where(x => x.GrupoId == FechasCP[0].Listado.Where(z => z.Nombre == "VACUNA").FirstOrDefault().Hijos.Where(y => y.Nombre == "ADMINISTRACIÓN DE VACUNA").FirstOrDefault().GrupoId && x.ParametroId == FechasCP[0].Listado.Where(z => z.Nombre == "VACUNA").FirstOrDefault().Hijos.Where(y => y.Nombre == "ADMINISTRACIÓN DE VACUNA").FirstOrDefault().ParameterId).FirstOrDefault().Comentario, fontColumnValue)) {Colspan =4,HorizontalAlignment = PdfPCell.ALIGN_LEFT }, 

                new PdfPCell(new Phrase("7", fontColumnValue)) { Colspan = 1, Rowspan=2,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE },
                new PdfPCell(new Phrase("Detección, Dx y Tto de:", fontColumnValue)) { Colspan = 4, Rowspan=2,HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE },
                new PdfPCell(new Phrase("Anemia", fontColumnValue)) { Colspan = 3,HorizontalAlignment = PdfPCell.ALIGN_LEFT },
                new PdfPCell(new Phrase(FechasCP.Count < 1 ? "" : FechasCP[0].Listado == null ? "" : FechasCP[0].Listado.Where(x => x.Nombre == "DETECCIÓN, DX Y TTO").FirstOrDefault().Hijos == null ? "" : FechasCP[0].Listado.Where(x => x.Nombre == "DETECCIÓN, DX Y TTO").FirstOrDefault().Hijos.Where(x => x.Nombre == "ANEMIA").FirstOrDefault() == null ? "" : FechasCP[0].Listado.Where(x => x.Nombre == "DETECCIÓN, DX Y TTO").FirstOrDefault().Hijos.Where(x => x.Nombre == "ANEMIA").FirstOrDefault().Valor ? "X" : "", fontColumnValue)) { Colspan =2, HorizontalAlignment = PdfPCell.ALIGN_CENTER },               
                ...
                new PdfPCell(new Phrase(ComentariosCP.Where(x => x.GrupoId == FechasCP[0].Listado.Where(z => z.Nombre == "DETECCIÓN, DX Y TTO").FirstOrDefault().Hijos.Where(y => y.Nombre == "ANEMIA").FirstOrDefault().GrupoId && x.ParametroId == FechasCP[0].Listado.Where(z => z.Nombre == "DETECCIÓN, DX Y TTO").FirstOrDefault().Hijos.Where(y => y.Nombre == "ANEMIA").FirstOrDefault().ParameterId).FirstOrDefault().Comentario, fontColumnValue)) {Colspan =4,HorizontalAlignment = PdfPCell.ALIGN_LEFT }, 

                new PdfPCell(new Phrase("Parasitosis", fontColumnValue)) { Colspan = 3,HorizontalAlignment = PdfPCell.ALIGN_LEFT },
                new PdfPCell(new Phrase(FechasCP.Count < 1 ? "" : FechasCP[0].Listado == null ? "" : FechasCP[0].Listado.Where(x => x.Nombre == "DETECCIÓN, DX Y TTO").FirstOrDefault().Hijos == null ? "" : FechasCP[0].Listado.Where(x => x.Nombre == "DETECCIÓN, DX Y TTO").FirstOrDefault().Hijos.Where(x => x.Nombre == "PARASITOSIS").FirstOrDefault() == null ? "" : FechasCP[0].Listado.Where(x => x.Nombre == "DETECCIÓN, DX Y TTO").FirstOrDefault().Hijos.Where(x => x.Nombre == "PARASITOSIS").FirstOrDefault().Valor ? "X" : "", fontColumnValue)) { Colspan =2, HorizontalAlignment = PdfPCell.ALIGN_CENTER },               
                ...
                new PdfPCell(new Phrase(ComentariosCP.Where(x => x.GrupoId == FechasCP[0].Listado.Where(z => z.Nombre == "DETECCIÓN, DX Y TTO").FirstOrDefault().Hijos.Where(y => y.Nombre == "PARASITOSIS").FirstOrDefault().GrupoId && x.ParametroId == FechasCP[0].Listado.Where(z => z.Nombre == "DETECCIÓN, DX Y TTO").FirstOrDefault().Hijos.Where(y => y.Nombre == "PARASITOSIS").FirstOrDefault().ParameterId).FirstOrDefault().Comentario, fontColumnValue)) {Colspan =4,HorizontalAlignment = PdfPCell.ALIGN_LEFT }, 

                new PdfPCell(new Phrase("8", fontColumnValue)) { Colspan = 1, Rowspan=3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE },
                new PdfPCell(new Phrase("Salud Bucal", fontColumnValue)) { Colspan = 3, Rowspan=3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_LEFT, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE },
                new PdfPCell(new Phrase("Atención Odontológica", fontColumnValue)) { Colspan = 4,HorizontalAlignment = PdfPCell.ALIGN_LEFT },
                new PdfPCell(new Phrase(FechasCP.Count < 1 ? "" : FechasCP[0].Listado == null ? "" : FechasCP[0].Listado.Where(x => x.Nombre == "SALUD BUCAL").FirstOrDefault().Hijos == null ? "" : FechasCP[0].Listado.Where(x => x.Nombre == "SALUD BUCAL").FirstOrDefault().Hijos.Where(x => x.Nombre == "ATENCIÓN ODONTOLÓGICA").FirstOrDefault() == null ? "" : FechasCP[0].Listado.Where(x => x.Nombre == "SALUD BUCAL").FirstOrDefault().Hijos.Where(x => x.Nombre == "ATENCIÓN ODONTOLÓGICA").FirstOrDefault().Valor ? "X" : "", fontColumnValue)) { Colspan =2, HorizontalAlignment = PdfPCell.ALIGN_CENTER },               
                ...
                new PdfPCell(new Phrase(ComentariosCP.Where(x => x.GrupoId == FechasCP[0].Listado.Where(z => z.Nombre == "SALUD BUCAL").FirstOrDefault().Hijos.Where(y => y.Nombre == "ATENCIÓN ODONTOLÓGICA").FirstOrDefault().GrupoId && x.ParametroId == FechasCP[0].Listado.Where(z => z.Nombre == "SALUD BUCAL").FirstOrDefault().Hijos.Where(y => y.Nombre == "ATENCIÓN ODONTOLÓGICA").FirstOrDefault().ParameterId).FirstOrDefault().Comentario, fontColumnValue)) {Colspan =4,HorizontalAlignment = PdfPCell.ALIGN_LEFT }, 

                new PdfPCell(new Phrase("Aplicación de barnices y/o sellantes", fontColumnValue)) { Colspan = 4,HorizontalAlignment = PdfPCell.ALIGN_LEFT },
                new PdfPCell(new Phrase(FechasCP.Count < 1 ? "" : FechasCP[0].Listado == null ? "" : FechasCP[0].Listado.Where(x => x.Nombre == "SALUD BUCAL").FirstOrDefault().Hijos == null ? "" : FechasCP[0].Listado.Where(x => x.Nombre == "SALUD BUCAL").FirstOrDefault().Hijos.Where(x => x.Nombre == "APLICACIÓN DE BARNICES Y/O SELLANTES").FirstOrDefault() == null ? "" : FechasCP[0].Listado.Where(x => x.Nombre == "SALUD BUCAL").FirstOrDefault().Hijos.Where(x => x.Nombre == "APLICACIÓN DE BARNICES Y/O SELLANTES").FirstOrDefault().Valor ? "X" : "", fontColumnValue)) { Colspan =2, HorizontalAlignment = PdfPCell.ALIGN_CENTER },               
                ...
                new PdfPCell(new Phrase(ComentariosCP.Where(x => x.GrupoId == FechasCP[0].Listado.Where(z => z.Nombre == "SALUD BUCAL").FirstOrDefault().Hijos.Where(y => y.Nombre == "APLICACIÓN DE BARNICES Y/O SELLANTES").FirstOrDefault().GrupoId && x.ParametroId == FechasCP[0].Listado.Where(z => z.Nombre == "SALUD BUCAL").FirstOrDefault().Hijos.Where(y => y.Nombre == "APLICACIÓN DE BARNICES Y/O SELLANTES").FirstOrDefault().ParameterId).FirstOrDefault().Comentario, fontColumnValue)) {Colspan =4,HorizontalAlignment = PdfPCell.ALIGN_LEFT }, 

                new PdfPCell(new Phrase("Tto. Recuperativo (obturac. y/o exodonc.)", fontColumnValue)) { Colspan = 4,HorizontalAlignment = PdfPCell.ALIGN_LEFT },
                new PdfPCell(new Phrase(FechasCP.Count < 1 ? "" : FechasCP[0].Listado == null ? "" : FechasCP[0].Listado.Where(x => x.Nombre == "SALUD BUCAL").FirstOrDefault().Hijos == null ? "" : FechasCP[0].Listado.Where(x => x.Nombre == "SALUD BUCAL").FirstOrDefault().Hijos.Where(x => x.Nombre == "TTO. RECUPERATIVO (OBTURAC. Y/O EXODONC.").FirstOrDefault() == null ? "" : FechasCP[0].Listado.Where(x => x.Nombre == "SALUD BUCAL").FirstOrDefault().Hijos.Where(x => x.Nombre == "TTO. RECUPERATIVO (OBTURAC. Y/O EXODONC.").FirstOrDefault().Valor ? "X" : "", fontColumnValue)) { Colspan =2, HorizontalAlignment = PdfPCell.ALIGN_CENTER },               
                ...
                new PdfPCell(new Phrase(ComentariosCP.Where(x => x.GrupoId == FechasCP[0].Listado.Where(z => z.Nombre == "VISITA").FirstOrDefault().Hijos.Where(y => y.Nombre == "VISITA FAMILIAR INTEGRAL").FirstOrDefault().GrupoId && x.ParametroId == FechasCP[0].Listado.Where(z => z.Nombre == "VISITA").FirstOrDefault().Hijos.Where(y => y.Nombre == "VISITA FAMILIAR INTEGRAL").FirstOrDefault().ParameterId).FirstOrDefault().Comentario, fontColumnValue)) {Colspan =4,HorizontalAlignment = PdfPCell.ALIGN_LEFT }, 

                new PdfPCell(new Phrase("10", fontColumnValue)) { Colspan = 1,HorizontalAlignment = PdfPCell.ALIGN_CENTER },
                new PdfPCell(new Phrase("Visita Familiar Integral", fontColumnValue)) { Colspan = 7,HorizontalAlignment = PdfPCell.ALIGN_LEFT },
                new PdfPCell(new Phrase(FechasCP.Count < 1 ? "" : FechasCP[0].Listado == null ? "" : FechasCP[0].Listado.Where(x => x.Nombre == "PATOLOGÍAS").FirstOrDefault().Hijos == null ? "" : FechasCP[0].Listado.Where(x => x.Nombre == "PATOLOGÍAS").FirstOrDefault().Hijos.Where(x => x.Nombre == "ATENCIÓN DE PATOLOGÍAS PREVALENTES").FirstOrDefault() == null ? "" : FechasCP[0].Listado.Where(x => x.Nombre == "PATOLOGÍAS").FirstOrDefault().Hijos.Where(x => x.Nombre == "ATENCIÓN DE PATOLOGÍAS PREVALENTES").FirstOrDefault().Valor ? "X" : "", fontColumnValue)) { Colspan =2, HorizontalAlignment = PdfPCell.ALIGN_CENTER },               
                ...
                new PdfPCell(new Phrase(ComentariosCP.Where(x => x.GrupoId == FechasCP[0].Listado.Where(z => z.Nombre == "PATOLOGÍAS").FirstOrDefault().Hijos.Where(y => y.Nombre == "ATENCIÓN DE PATOLOGÍAS PREVALENTES").FirstOrDefault().GrupoId && x.ParametroId == FechasCP[0].Listado.Where(z => z.Nombre == "PATOLOGÍAS").FirstOrDefault().Hijos.Where(y => y.Nombre == "ATENCIÓN DE PATOLOGÍAS PREVALENTES").FirstOrDefault().ParameterId).FirstOrDefault().Comentario, fontColumnValue)) {Colspan =4,HorizontalAlignment = PdfPCell.ALIGN_LEFT }, 

                new PdfPCell(new Phrase("11", fontColumnValue)) { Colspan = 1,HorizontalAlignment = PdfPCell.ALIGN_CENTER },
                new PdfPCell(new Phrase("Sesiones educativas", fontColumnValue)) { Colspan = 7,HorizontalAlignment = PdfPCell.ALIGN_LEFT },
                new PdfPCell(new Phrase(FechasCP.Count < 1 ? "" : FechasCP[0].Listado == null ? "" : FechasCP[0].Listado.Where(x => x.Nombre == "SESIONES").FirstOrDefault().Hijos == null ? "" : FechasCP[0].Listado.Where(x => x.Nombre == "SESIONES").FirstOrDefault().Hijos.Where(x => x.Nombre == "SESIONES EDUCATIVAS").FirstOrDefault() == null ? "" : FechasCP[0].Listado.Where(x => x.Nombre == "SESIONES").FirstOrDefault().Hijos.Where(x => x.Nombre == "SESIONES EDUCATIVAS").FirstOrDefault().Valor ? "X" : "", fontColumnValue)) { Colspan =2, HorizontalAlignment = PdfPCell.ALIGN_CENTER },               
                ...
                new PdfPCell(new Phrase(ComentariosCP.Where(x => x.GrupoId == FechasCP[0].Listado.Where(z => z.Nombre == "SESIONES").FirstOrDefault().Hijos.Where(y => y.Nombre == "SESIONES EDUCATIVAS").FirstOrDefault().GrupoId && x.ParametroId == FechasCP[0].Listado.Where(z => z.Nombre == "SESIONES").FirstOrDefault().Hijos.Where(y => y.Nombre == "SESIONES EDUCATIVAS").FirstOrDefault().ParameterId).FirstOrDefault().Comentario, fontColumnValue)) {Colspan =4,HorizontalAlignment = PdfPCell.ALIGN_LEFT }, 

                new PdfPCell(new Phrase("12", fontColumnValue)) { Colspan = 1,HorizontalAlignment = PdfPCell.ALIGN_CENTER },
                new PdfPCell(new Phrase("Sesiones demostrativas", fontColumnValue)) { Colspan = 7,HorizontalAlignment = PdfPCell.ALIGN_LEFT },
                new PdfPCell(new Phrase(FechasCP.Count < 1 ? "" : FechasCP[0].Listado == null ? "" : FechasCP[0].Listado.Where(x => x.Nombre == "SESIONES").FirstOrDefault().Hijos == null ? "" : FechasCP[0].Listado.Where(x => x.Nombre == "SESIONES").FirstOrDefault().Hijos.Where(x => x.Nombre == "SESIONES DEMOSTRATIVAS").FirstOrDefault() == null ? "" : FechasCP[0].Listado.Where(x => x.Nombre == "SESIONES").FirstOrDefault().Hijos.Where(x => x.Nombre == "SESIONES DEMOSTRATIVAS").FirstOrDefault().Valor ? "X" : "", fontColumnValue)) { Colspan =2, HorizontalAlignment = PdfPCell.ALIGN_CENTER },               
                ...
                new PdfPCell(new Phrase(ComentariosCP.Where(x => x.GrupoId == FechasCP[0].Listado.Where(z => z.Nombre == "SESIONES").FirstOrDefault().Hijos.Where(y => y.Nombre == "SESIONES DEMOSTRATIVAS").FirstOrDefault().GrupoId && x.ParametroId == FechasCP[0].Listado.Where(z => z.Nombre == "SESIONES").FirstOrDefault().Hijos.Where(y => y.Nombre == "SESIONES DEMOSTRATIVAS").FirstOrDefault().ParameterId).FirstOrDefault().Comentario, fontColumnValue)) {Colspan =4,HorizontalAlignment = PdfPCell.ALIGN_LEFT }, 

                new PdfPCell(new Phrase("13", fontColumnValue)) { Colspan = 1,HorizontalAlignment = PdfPCell.ALIGN_CENTER },
                new PdfPCell(new Phrase("Otras prestaciones", fontColumnValue)) { Colspan = 7,HorizontalAlignment = PdfPCell.ALIGN_LEFT },
                new PdfPCell(new Phrase(FechasCP.Count < 1 ? "" : FechasCP[0].Listado == null ? "" : FechasCP[0].Listado.Where(x => x.Nombre == "OTROS").FirstOrDefault().Hijos == null ? "" : FechasCP[0].Listado.Where(x => x.Nombre == "OTROS").FirstOrDefault().Hijos.Where(x => x.Nombre == "OTRAS_PRESTACIONES").FirstOrDefault() == null ? "" : FechasCP[0].Listado.Where(x => x.Nombre == "OTROS").FirstOrDefault().Hijos.Where(x => x.Nombre == "OTRAS_PRESTACIONES").FirstOrDefault().Valor ? "X" : "", fontColumnValue)) { Colspan =2, HorizontalAlignment = PdfPCell.ALIGN_CENTER },               
                ...
                new PdfPCell(new Phrase(ComentariosCP.Where(x => x.GrupoId == FechasCP[0].Listado.Where(z => z.Nombre == "OTROS").FirstOrDefault().Hijos.Where(y => y.Nombre == "OTRAS_PRESTACIONES").FirstOrDefault().GrupoId && x.ParametroId == FechasCP[0].Listado.Where(z => z.Nombre == "OTROS").FirstOrDefault().Hijos.Where(y => y.Nombre == "OTRAS_PRESTACIONES").FirstOrDefault().ParameterId).FirstOrDefault().Comentario, fontColumnValue)) {Colspan =4,HorizontalAlignment = PdfPCell.ALIGN_LEFT }, 
            ...
            {          
                ...
                ///texto
                new PdfPCell(new Phrase(Antecedentes == null ? null : Antecedentes.Where(x => x.Nombre == "ANTECEDENTES PERINATALES").FirstOrDefault() == null ? null:
                Antecedentes.Where(x => x.Nombre == "ANTECEDENTES PERINATALES").FirstOrDefault().Hijos.Where(x => x.Nombre == "EDAD_GEST_NACER").FirstOrDefault() == null ? "" : 
                Antecedentes.Where(x => x.Nombre == "ANTECEDENTES PERINATALES").FirstOrDefault().Hijos.Where(x => x.Nombre == "EDAD_GEST_NACER").FirstOrDefault().SI ? "X" : "", fontColumnValue)) 
                ...
                /////
                new PdfPCell(new Phrase(Antecedentes == null ? null : Antecedentes.Where(x => x.Nombre == "ANTECEDENTES PERINATALES").FirstOrDefault() == null ? null:
                Antecedentes.Where(x => x.Nombre == "ANTECEDENTES PERINATALES").FirstOrDefault().Hijos.Where(x => x.Nombre == "PESO_NACER").FirstOrDefault() == null ? "" : 
                Antecedentes.Where(x => x.Nombre == "ANTECEDENTES PERINATALES").FirstOrDefault().Hijos.Where(x => x.Nombre == "PESO_NACER").FirstOrDefault().SI ? "X" : "", fontColumnValue)) 
                { Colspan =3, HorizontalAlignment = PdfPCell.ALIGN_LEFT }, 
                ///
                ...
                //////
                new PdfPCell(new Phrase(Antecedentes == null ? null : Antecedentes.Where(x => x.Nombre == "ANTECEDENTES PERINATALES").FirstOrDefault() == null ? null:
                Antecedentes.Where(x => x.Nombre == "ANTECEDENTES PERINATALES").FirstOrDefault().Hijos.Where(x => x.Nombre == "PATOLOGIAS").FirstOrDefault() == null ? "" : 
                Antecedentes.Where(x => x.Nombre == "ANTECEDENTES PERINATALES").FirstOrDefault().Hijos.Where(x => x.Nombre == "PATOLOGIAS").FirstOrDefault().SI ? "X" : "", fontColumnValue)) 
                { Colspan =10, Rowspan=2, HorizontalAlignment = PdfPCell.ALIGN_LEFT }, 
                ///////
                new PdfPCell(new Phrase("Talla al nacer (cm)", fontColumnValue)) { Colspan = 5, HorizontalAlignment = PdfPCell.ALIGN_LEFT },
                new PdfPCell(new Phrase(Antecedentes == null ? null : Antecedentes.Where(x => x.Nombre == "ANTECEDENTES PERINATALES").FirstOrDefault() == null ? null:
                Antecedentes.Where(x => x.Nombre == "ANTECEDENTES PERINATALES").FirstOrDefault().Hijos.Where(x => x.Nombre == "TALLA_NACER").FirstOrDefault() == null ? "" : 
                Antecedentes.Where(x => x.Nombre == "ANTECEDENTES PERINATALES").FirstOrDefault().Hijos.Where(x => x.Nombre == "TALLA_NACER").FirstOrDefault().SI ? "X" : "", fontColumnValue)) 
                { Colspan =3, HorizontalAlignment = PdfPCell.ALIGN_LEFT },
                /////
                ...
                ///////
                new PdfPCell(new Phrase(Antecedentes == null ? null : Antecedentes.Where(x => x.Nombre == "ANTECEDENTES PERINATALES").FirstOrDefault() == null ? null:
                Antecedentes.Where(x => x.Nombre == "ANTECEDENTES PERINATALES").FirstOrDefault().Hijos.Where(x => x.Nombre == "PERIMETRO_CEFALICO").FirstOrDefault() == null ? "" : 
                Antecedentes.Where(x => x.Nombre == "ANTECEDENTES PERINATALES").FirstOrDefault().Hijos.Where(x => x.Nombre == "PERIMETRO_CEFALICO").FirstOrDefault().SI ? "X" : "", fontColumnValue)) 
                { Colspan =3, HorizontalAlignment = PdfPCell.ALIGN_LEFT },
                /////                
                ...
                new PdfPCell(new Phrase("Nº de embarazo", fontColumnValue)) { Colspan = 8, HorizontalAlignment = PdfPCell.ALIGN_LEFT }, 
                 ///////
                new PdfPCell(new Phrase(Antecedentes == null ? null : Antecedentes.Where(x => x.Nombre == "ANTECEDENTES PERINATALES").FirstOrDefault() == null ? null:
                Antecedentes.Where(x => x.Nombre == "ANTECEDENTES PERINATALES").FirstOrDefault().Hijos.Where(x => x.Nombre == "N° EMBARAZOS").FirstOrDefault() == null ? "" : 
                Antecedentes.Where(x => x.Nombre == "ANTECEDENTES PERINATALES").FirstOrDefault().Hijos.Where(x => x.Nombre == "N° EMBARAZOS").FirstOrDefault().SI ? "X" : "", fontColumnValue)) 
                ...
                ///////
                new PdfPCell(new Phrase(Antecedentes == null ? null : Antecedentes.Where(x => x.Nombre == "ANTECEDENTES PERINATALES").FirstOrDefault() == null ? null:
                Antecedentes.Where(x => x.Nombre == "ANTECEDENTES PERINATALES").FirstOrDefault().Hijos.Where(x => x.Nombre == "PERIMETRO_TORACICO").FirstOrDefault() == null ? "" : 
                Antecedentes.Where(x => x.Nombre == "ANTECEDENTES PERINATALES").FirstOrDefault().Hijos.Where(x => x.Nombre == "PERIMETRO_TORACICO").FirstOrDefault().SI ? "X" : "", fontColumnValue)) 
                { Colspan =3, HorizontalAlignment = PdfPCell.ALIGN_LEFT },
                /////  
                ...
                ///////
                new PdfPCell(new Phrase(Antecedentes == null ? null : Antecedentes.Where(x => x.Nombre == "ANTECEDENTES PERINATALES").FirstOrDefault() == null ? null:
                Antecedentes.Where(x => x.Nombre == "ANTECEDENTES PERINATALES").FirstOrDefault().Hijos.Where(x => x.Nombre == "N° APN").FirstOrDefault() == null ? "" : 
                Antecedentes.Where(x => x.Nombre == "ANTECEDENTES PERINATALES").FirstOrDefault().Hijos.Where(x => x.Nombre == "N° APN").FirstOrDefault().SI ? "X" : "", fontColumnValue)) 
                { Colspan =1, HorizontalAlignment = PdfPCell.ALIGN_LEFT },
                /////  
                ...
                new PdfPCell(new Phrase("Lugar de APN", fontColumnValue)) { Colspan = 4, HorizontalAlignment = PdfPCell.ALIGN_LEFT }, 
                 ///////
                new PdfPCell(new Phrase(Antecedentes == null ? null : Antecedentes.Where(x => x.Nombre == "ANTECEDENTES PERINATALES").FirstOrDefault() == null ? null:
                Antecedentes.Where(x => x.Nombre == "ANTECEDENTES PERINATALES").FirstOrDefault().Hijos.Where(x => x.Nombre == "LUGAR APN").FirstOrDefault() == null ? "" : 
                Antecedentes.Where(x => x.Nombre == "ANTECEDENTES PERINATALES").FirstOrDefault().Hijos.Where(x => x.Nombre == "LUGAR APN").FirstOrDefault().SI ? "X" : "", fontColumnValue)) 
                ...
                { Colspan =1, HorizontalAlignment = PdfPCell.ALIGN_LEFT },                new PdfPCell(new Phrase("-", fontColumnValue)) { Colspan = 7, HorizontalAlignment = PdfPCell.ALIGN_LEFT },
                ...
                new PdfPCell(new Phrase(Antecedentes == null ? null : Antecedentes.Where(x => x.Nombre == "ANTECEDENTES PATOLOGICOS").FirstOrDefault() == null ? null:
                Antecedentes.Where(x => x.Nombre == "ANTECEDENTES PATOLOGICOS").FirstOrDefault().Hijos.Where(x => x.Nombre == "OTROS").FirstOrDefault() == null ? "" : 
                Antecedentes.Where(x => x.Nombre == "ANTECEDENTES PATOLOGICOS").FirstOrDefault().Hijos.Where(x => x.Nombre == "OTROS").FirstOrDefault().SI ? "X" : "", fontColumnValue)) 
                { Colspan =6, HorizontalAlignment = PdfPCell.ALIGN_LEFT },

                new PdfPCell(new Phrase(Antecedentes == null ? null : Antecedentes.Where(x => x.Nombre == "ANTECEDENTES PERINATALES").FirstOrDefault() == null ? null:
                Antecedentes.Where(x => x.Nombre == "ANTECEDENTES PERINATALES").FirstOrDefault().Hijos.Where(x => x.Nombre == "COMPLICACIONES DEL PARTO").FirstOrDefault() == null ? "" : 
                Antecedentes.Where(x => x.Nombre == "ANTECEDENTES PERINATALES").FirstOrDefault().Hijos.Where(x => x.Nombre == "COMPLICACIONES DEL PARTO").FirstOrDefault().SI ? "X" : "", fontColumnValue)) 
                { Colspan = 10, Rowspan = 2, HorizontalAlignment = PdfPCell.ALIGN_LEFT },
                ...
                new PdfPCell(new Phrase(Antecedentes == null ? null : Antecedentes.Where(x => x.Nombre == "ANTECEDENTES PERINATALES").FirstOrDefault() == null ? null:
                Antecedentes.Where(x => x.Nombre == "ANTECEDENTES PERINATALES").FirstOrDefault().Hijos.Where(x => x.Nombre == "TEMP_HOSPITALIZACION_RESP").FirstOrDefault() == null ? "" : 
                Antecedentes.Where(x => x.Nombre == "ANTECEDENTES PERINATALES").FirstOrDefault().Hijos.Where(x => x.Nombre == "TEMP_HOSPITALIZACION_RESP").FirstOrDefault().SI ? "X" : "", fontColumnValue)) 
                { Colspan =3, HorizontalAlignment = PdfPCell.ALIGN_LEFT },
                ...
                Antecedentes.Where(x => x.Nombre == "ANTECEDENTES ALIMENTACION").FirstOrDefault().Hijos.Where(x => x.Nombre == "LME").FirstOrDefault() == null ? "" : 
                Antecedentes.Where(x => x.Nombre == "ANTECEDENTES ALIMENTACION").FirstOrDefault().Hijos.Where(x => x.Nombre == "LME").FirstOrDefault().SI ? "X" : "", fontColumnValue)) 
                { Colspan =2, HorizontalAlignment = PdfPCell.ALIGN_LEFT },
                ///////
                ...
                new PdfPCell(new Phrase("Mixta:", fontColumnValueBold)) { Colspan = 2, HorizontalAlignment = PdfPCell.ALIGN_LEFT },
                 ///////
                new PdfPCell(new Phrase(Antecedentes == null ? null : Antecedentes.Where(x => x.Nombre == "ANTECEDENTES ALIMENTACION").FirstOrDefault() == null ? null:
                Antecedentes.Where(x => x.Nombre == "ANTECEDENTES ALIMENTACION").FirstOrDefault().Hijos.Where(x => x.Nombre == "MIXTA").FirstOrDefault() == null ? "" : 
                Antecedentes.Where(x => x.Nombre == "ANTECEDENTES ALIMENTACION").FirstOrDefault().Hijos.Where(x => x.Nombre == "MIXTA").FirstOrDefault().SI ? "X" : "", fontColumnValue)) 
                { Colspan =2, HorizontalAlignment = PdfPCell.ALIGN_LEFT },
                ///////
                ...
                ///////
                new PdfPCell(new Phrase(Antecedentes == null ? null : Antecedentes.Where(x => x.Nombre == "ANTECEDENTES ALIMENTACION").FirstOrDefault() == null ? null:
                Antecedentes.Where(x => x.Nombre == "ANTECEDENTES ALIMENTACION").FirstOrDefault().Hijos.Where(x => x.Nombre == "ARTIFICIAL").FirstOrDefault() == null ? "" : 
                Antecedentes.Where(x => x.Nombre == "ANTECEDENTES ALIMENTACION").FirstOrDefault().Hijos.Where(x => x.Nombre == "ARTIFICIAL").FirstOrDefault().SI ? "X" : "", fontColumnValue)) 
                { Colspan =2, HorizontalAlignment = PdfPCell.ALIGN_LEFT },
                ///////
                ...
                Antecedentes.Where(x => x.Nombre == "ANTECEDENTES ALIMENTACION").FirstOrDefault().Hijos.Where(x => x.Nombre == "ARTIFICIAL").FirstOrDefault() == null ? "" : 
                Antecedentes.Where(x => x.Nombre == "ANTECEDENTES ALIMENTACION").FirstOrDefault().Hijos.Where(x => x.Nombre == "ARTIFICIAL").FirstOrDefault().SI ? "X" : "", fontColumnValue)) 
                { Colspan =3,Rowspan = 2, HorizontalAlignment = PdfPCell.ALIGN_LEFT },
                ///////
                ...
                new PdfPCell(new Phrase(Antecedentes == null ? null : Antecedentes.Where(x => x.Nombre == "ANTECEDENTES PERINATALES").FirstOrDefault() == null ? null:
                Antecedentes.Where(x => x.Nombre == "ANTECEDENTES PERINATALES").FirstOrDefault().Hijos.Where(x => x.Nombre == "OTRO").FirstOrDefault() == null ? "" : 
                Antecedentes.Where(x => x.Nombre == "ANTECEDENTES PERINATALES").FirstOrDefault().Hijos.Where(x => x.Nombre == "OTRO").FirstOrDefault().SI ? "X" : "", fontColumnValue)) 
                { Colspan =6, Rowspan=2, HorizontalAlignment = PdfPCell.ALIGN_LEFT },
