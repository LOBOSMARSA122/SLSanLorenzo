...
namespace NetPdf
{
    public class Exoneracion_Placa_Torax_PA
    {
            ...
            List<DiagnosticRepositoryList> Diagnosticos)
        {
            ...
            var cellsTit = new List<PdfPCell>()
                { 
                    new PdfPCell(new Phrase("EXONERAXIÓN DE PLACA DE TORAX P-A", fontTitle1)) { BackgroundColor= BaseColor.ORANGE, HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = 30f, BorderColor=BaseColor.WHITE },
                };
