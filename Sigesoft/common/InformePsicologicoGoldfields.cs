            ...
            string filePDF)
        {
           ...
           if (conducira == "1") conduciraXSI = "X";
            ...
            {         
                ...
                new PdfPCell(new Phrase(coeficiente_intelectual == "1" ?"X":coeficiente_intelectual=="2"?"":coeficiente_intelectual=="3"?"":coeficiente_intelectual=="4"?"":coeficiente_intelectual=="5"?"":coeficiente_intelectual, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(coeficiente_intelectual == "1" ?"":coeficiente_intelectual=="2"?"X":coeficiente_intelectual=="3"?"":coeficiente_intelectual=="4"?"":coeficiente_intelectual=="5"?"":coeficiente_intelectual, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(coeficiente_intelectual == "1" ?"":coeficiente_intelectual=="2"?"":coeficiente_intelectual=="3"?"X":coeficiente_intelectual=="4"?"":coeficiente_intelectual=="5"?"":coeficiente_intelectual, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(coeficiente_intelectual == "1" ?"":coeficiente_intelectual=="2"?"":coeficiente_intelectual=="3"?"":coeficiente_intelectual=="4"?"X":coeficiente_intelectual=="5"?"":coeficiente_intelectual, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
            ...
            {         
                ...
                new PdfPCell(new Phrase(orientacion == "1" ?"X":orientacion=="2"?"":orientacion=="3"?"":orientacion=="4"?"":orientacion=="5"?"":orientacion, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(orientacion == "1" ?"":orientacion=="2"?"X":orientacion=="3"?"":orientacion=="4"?"":orientacion=="5"?"":orientacion, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(orientacion == "1" ?"":orientacion=="2"?"":orientacion=="3"?"X":orientacion=="4"?"":orientacion=="5"?"":orientacion, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(orientacion == "1" ?"":orientacion=="2"?"":orientacion=="3"?"":orientacion=="4"?"X":orientacion=="5"?"":orientacion, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(orientacion == "1" ?"":orientacion=="2"?"":orientacion=="3"?"":orientacion=="4"?"":orientacion=="5"?"X":orientacion, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                ...
                new PdfPCell(new Phrase(atencion == "1" ?"X":atencion=="2"?"":atencion=="3"?"":atencion=="4"?"":atencion=="5"?"":atencion, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(atencion == "1" ?"":atencion=="2"?"X":atencion=="3"?"":atencion=="4"?"":atencion=="5"?"":atencion, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(atencion == "1" ?"":atencion=="2"?"":atencion=="3"?"X":atencion=="4"?"":atencion=="5"?"":atencion, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(atencion == "1" ?"":atencion=="2"?"":atencion=="3"?"":atencion=="4"?"X":atencion=="5"?"":atencion, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(atencion == "1" ?"":atencion=="2"?"":atencion=="3"?"":atencion=="4"?"":atencion=="5"?"X":atencion, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                ...
                new PdfPCell(new Phrase(memoria == "1" ?"X":memoria=="2"?"":memoria=="3"?"":memoria=="4"?"":memoria=="5"?"":memoria, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(memoria == "1" ?"":memoria=="2"?"X":memoria=="3"?"":memoria=="4"?"":memoria=="5"?"":memoria, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(memoria == "1" ?"":memoria=="2"?"":memoria=="3"?"X":memoria=="4"?"":memoria=="5"?"":memoria, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(memoria == "1" ?"":memoria=="2"?"":memoria=="3"?"":memoria=="4"?"X":memoria=="5"?"":memoria, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(memoria == "1" ?"":memoria=="2"?"":memoria=="3"?"":memoria=="4"?"":memoria=="5"?"X":memoria, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                ...
                new PdfPCell(new Phrase(comprension == "1" ?"X":comprension=="2"?"":comprension=="3"?"":comprension=="4"?"":comprension=="5"?"":comprension, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(comprension == "1" ?"":comprension=="2"?"X":comprension=="3"?"":comprension=="4"?"":comprension=="5"?"":comprension, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(comprension == "1" ?"":comprension=="2"?"":comprension=="3"?"X":comprension=="4"?"":comprension=="5"?"":comprension, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
            ...
            {         
                ...
                new PdfPCell(new Phrase(trabajo_equipo == "1" ?"X":trabajo_equipo=="2"?"":trabajo_equipo=="3"?"":trabajo_equipo=="4"?"":trabajo_equipo=="5"?"":trabajo_equipo, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(trabajo_equipo == "1" ?"":trabajo_equipo=="2"?"X":trabajo_equipo=="3"?"":trabajo_equipo=="4"?"":trabajo_equipo=="5"?"":trabajo_equipo, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(trabajo_equipo == "1" ?"":trabajo_equipo=="2"?"":trabajo_equipo=="3"?"X":trabajo_equipo=="4"?"":trabajo_equipo=="5"?"":trabajo_equipo, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(trabajo_equipo == "1" ?"":trabajo_equipo=="2"?"":trabajo_equipo=="3"?"":trabajo_equipo=="4"?"X":trabajo_equipo=="5"?"":trabajo_equipo, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(trabajo_equipo == "1" ?"":trabajo_equipo=="2"?"":trabajo_equipo=="3"?"":trabajo_equipo=="4"?"":trabajo_equipo=="5"?"X":trabajo_equipo, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                ...
                new PdfPCell(new Phrase(comunicacion == "1" ?"X":comunicacion=="2"?"":comunicacion=="3"?"":comunicacion=="4"?"":comunicacion=="5"?"":comunicacion, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(comunicacion == "1" ?"":comunicacion=="2"?"X":comunicacion=="3"?"":comunicacion=="4"?"":comunicacion=="5"?"":comunicacion, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(comunicacion == "1" ?"":comunicacion=="2"?"":comunicacion=="3"?"X":comunicacion=="4"?"":comunicacion=="5"?"":comunicacion, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(comunicacion == "1" ?"":comunicacion=="2"?"":comunicacion=="3"?"":comunicacion=="4"?"X":comunicacion=="5"?"":comunicacion, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(comunicacion == "1" ?"":comunicacion=="2"?"":comunicacion=="3"?"":comunicacion=="4"?"":comunicacion=="5"?"X":comunicacion, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                ...
                new PdfPCell(new Phrase(compromiso == "1" ?"X":compromiso=="2"?"":compromiso=="3"?"":compromiso=="4"?"":compromiso=="5"?"":compromiso, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(compromiso == "1" ?"":compromiso=="2"?"X":compromiso=="3"?"":compromiso=="4"?"":compromiso=="5"?"":compromiso, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(compromiso == "1" ?"":compromiso=="2"?"":compromiso=="3"?"X":compromiso=="4"?"":compromiso=="5"?"":compromiso, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(compromiso == "1" ?"":compromiso=="2"?"":compromiso=="3"?"":compromiso=="4"?"X":compromiso=="5"?"":compromiso, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(compromiso == "1" ?"":compromiso=="2"?"":compromiso=="3"?"":compromiso=="4"?"":compromiso=="5"?"X":compromiso, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                ...
                new PdfPCell(new Phrase(motivacion == "1" ?"X":motivacion=="2"?"":motivacion=="3"?"":motivacion=="4"?"":motivacion=="5"?"":motivacion, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(motivacion == "1" ?"":motivacion=="2"?"X":motivacion=="3"?"":motivacion=="4"?"":motivacion=="5"?"":motivacion, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(motivacion == "1" ?"":motivacion=="2"?"":motivacion=="3"?"X":motivacion=="4"?"":motivacion=="5"?"":motivacion, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
            ...
            {         
                ...
                new PdfPCell(new Phrase("Orientación", fontColumnValueBold)) { Colspan =5,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(orientacion1 == "1" ?"X":orientacion1=="2"?"":orientacion1=="3"?"":orientacion1=="4"?"":orientacion1=="5"?"":orientacion1, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(orientacion1 == "1" ?"":orientacion1=="2"?"X":orientacion1=="3"?"":orientacion1=="4"?"":orientacion1=="5"?"":orientacion1, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(orientacion1 == "1" ?"":orientacion1=="2"?"":orientacion1=="3"?"X":orientacion1=="4"?"":orientacion1=="5"?"":orientacion1, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(orientacion1 == "1" ?"":orientacion1=="2"?"":orientacion1=="3"?"":orientacion1=="4"?"X":orientacion1=="5"?"":orientacion1, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(orientacion1 == "1" ?"":orientacion1=="2"?"":orientacion1=="3"?"":orientacion1=="4"?"":orientacion1=="5"?"X":orientacion1, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    

                new PdfPCell(new Phrase("Atención y concentración", fontColumnValueBold)) { Colspan =5, HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(atencion1 == "1" ?"X":atencion1=="2"?"":atencion1=="3"?"":atencion1=="4"?"":atencion1=="5"?"":atencion1, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(atencion1 == "1" ?"":atencion1=="2"?"X":atencion1=="3"?"":atencion1=="4"?"":atencion1=="5"?"":atencion1, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(atencion1 == "1" ?"":atencion1=="2"?"":atencion1=="3"?"X":atencion1=="4"?"":atencion1=="5"?"":atencion1, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(atencion1 == "1" ?"":atencion1=="2"?"":atencion1=="3"?"":atencion1=="4"?"X":atencion1=="5"?"":atencion1, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(atencion1 == "1" ?"":atencion1=="2"?"":atencion1=="3"?"":atencion1=="4"?"":atencion1=="5"?"X":atencion1, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    

                new PdfPCell(new Phrase("Memoria", fontColumnValueBold)) { Colspan =5, HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(memoria1 == "1" ?"X":memoria1=="2"?"":memoria1=="3"?"":memoria1=="4"?"":memoria1=="5"?"":memoria1, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(memoria1 == "1" ?"":memoria1=="2"?"X":memoria1=="3"?"":memoria1=="4"?"":memoria1=="5"?"":memoria1, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(memoria1 == "1" ?"":memoria1=="2"?"":memoria1=="3"?"X":memoria1=="4"?"":memoria1=="5"?"":memoria1, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(memoria1 == "1" ?"":memoria1=="2"?"":memoria1=="3"?"":memoria1=="4"?"X":memoria1=="5"?"":memoria1, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(memoria1 == "1" ?"":memoria1=="2"?"":memoria1=="3"?"":memoria1=="4"?"":memoria1=="5"?"X":memoria1, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                ...
                new PdfPCell(new Phrase(habilidades_visoconstructivas == "1" ?"X":habilidades_visoconstructivas=="2"?"":habilidades_visoconstructivas=="3"?"":habilidades_visoconstructivas=="4"?"":habilidades_visoconstructivas=="5"?"":habilidades_visoconstructivas, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(habilidades_visoconstructivas == "1" ?"":habilidades_visoconstructivas=="2"?"X":habilidades_visoconstructivas=="3"?"":habilidades_visoconstructivas=="4"?"":habilidades_visoconstructivas=="5"?"":habilidades_visoconstructivas, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(habilidades_visoconstructivas == "1" ?"":habilidades_visoconstructivas=="2"?"":habilidades_visoconstructivas=="3"?"X":habilidades_visoconstructivas=="4"?"":habilidades_visoconstructivas=="5"?"":habilidades_visoconstructivas, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                ...
                new PdfPCell(new Phrase("Comprensión", fontColumnValueBold)) { Colspan =5, HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(comprension1 == "1" ?"X":comprension1=="2"?"":comprension1=="3"?"":comprension1=="4"?"":comprension1=="5"?"":comprension1, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(comprension1 == "1" ?"":comprension1=="2"?"X":comprension1=="3"?"":comprension1=="4"?"":comprension1=="5"?"":comprension1, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(comprension1 == "1" ?"":comprension1=="2"?"":comprension1=="3"?"X":comprension1=="4"?"":comprension1=="5"?"":comprension1, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(comprension1 == "1" ?"":comprension1=="2"?"":comprension1=="3"?"":comprension1=="4"?"X":comprension1=="5"?"":comprension1, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(comprension1 == "1" ?"":comprension1=="2"?"":comprension1=="3"?"":comprension1=="4"?"":comprension1=="5"?"X":comprension1, fontColumnValue)) { Colspan =3,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
            ...
            {         
                ...
                new PdfPCell(new Phrase(esencia_tarea == "1" ?"X":esencia_tarea=="2"?"":esencia_tarea=="3"?"":esencia_tarea, fontColumnValue)) { Colspan =5,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(esencia_tarea == "1" ?"":esencia_tarea=="2"?"X":esencia_tarea=="3"?"":esencia_tarea, fontColumnValue)) { Colspan =5,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(esencia_tarea == "1" ?"":esencia_tarea=="2"?"":esencia_tarea=="3"?"X":esencia_tarea, fontColumnValue)) { Colspan =5,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                ...
                new PdfPCell(new Phrase(sistema_trabajo == "1" ?"X":sistema_trabajo=="2"?"":sistema_trabajo=="3"?"":sistema_trabajo, fontColumnValue)) { Colspan =5,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(sistema_trabajo == "1" ?"":sistema_trabajo=="2"?"X":sistema_trabajo=="3"?"":sistema_trabajo, fontColumnValue)) { Colspan =5,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(sistema_trabajo == "1" ?"":sistema_trabajo=="2"?"":sistema_trabajo=="3"?"X":sistema_trabajo, fontColumnValue)) { Colspan =5,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                ...
                new PdfPCell(new Phrase(interaccion_social == "1" ?"X":interaccion_social=="2"?"":interaccion_social=="3"?"":interaccion_social, fontColumnValue)) { Colspan =5,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(interaccion_social == "1" ?"":interaccion_social=="2"?"X":interaccion_social=="3"?"":interaccion_social, fontColumnValue)) { Colspan =5,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                new PdfPCell(new Phrase(interaccion_social == "1" ?"":interaccion_social=="2"?"":interaccion_social=="3"?"X":interaccion_social, fontColumnValue)) { Colspan =5,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
                ...
                new PdfPCell(new Phrase(organizaciones == "1" ?"X":organizaciones=="2"?"":organizaciones=="3"?"":organizaciones, fontColumnValue)) { Colspan =5,HorizontalAlignment = iTextSharp.text.Element.ALIGN_CENTER, VerticalAlignment = iTextSharp.text.Element.ALIGN_MIDDLE, MinimumHeight = tamaño_celda},    
