<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmAntecedentePersonal.aspx.cs" Inherits="Sigesoft.Server.WebClientAdmin.UI.Consultorios.frmAntecedentePersonal" %>
                ...
                <Items>
                    <x:SimpleForm ID="SimpleForm1" ShowBorder="false" ShowHeader="false" EnableBackgroundColor="true" 
                        ...
                        <Items>
                            ...
                            CompareOperator="NotEqual" CompareMessage="Campo requerido" OnSelectedIndexChanged="ddlDx_SelectedIndexChanged" AutoPostBack="true" ></x:DropDownList>
                             <x:TextArea ID="txtOtroDx" Label="Otro Dx" runat="server" TabIndex="2" Height="35" Readonly="true"/>
                            <x:DropDownList ID="ddlTipoDx"  runat="server" Label="Tipo Dx" TabIndex="3" EnableSimulateTree="true" ShowRedStar="true" CompareType="String" CompareValue="-1"
                            CompareOperator="NotEqual" CompareMessage="Campo requerido" ></x:DropDownList>
                            <x:DatePicker ID="dtcFechaInicio" runat="server" Label="Fecha de Inicio" TabIndex="4" Width="120" Required="true" DateFormatString="dd/MM/yyyy"></x:DatePicker>
                            <x:CheckBox runat="server" ID="chkSoloAnio"  Label="Tomar solo Año"></x:CheckBox>                            
                            <x:TextArea ID="txtDetalle" Label="Detalle" Required="true" ShowRedStar="true" runat="server" TabIndex="5" Height="40"/>
                            <x:TextArea ID="txtDiasDescanso" Label="Descanso" runat="server" TabIndex="6" Height="55"/>                   
                        </Items>
                    </x:SimpleForm>
                </Items>
            </x:Panel>
