<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmFirmaMedico.aspx.cs" Inherits="Sigesoft.Server.WebClientAdmin.UI.Consultorios.frmFirmaMedico" %>
                 ...
                 <x:Panel ID="Panel4" Layout="Fit" runat="server" ShowBorder="false" ShowHeader="false" >
                    <Items>
                        ...
                        AutoScroll="true" runat="server" EnableCollapse="True"  LabelWidth="130px" >                        
                            <Items>     
                                <x:DropDownList ID="ddlUsuarioGrabar" runat="server" Text="Usuario"></x:DropDownList>
                            </Items>
                        </x:SimpleForm>
                    </Items>
                </x:Panel>
