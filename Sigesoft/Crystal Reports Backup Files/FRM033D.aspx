<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FRM033D.aspx.cs" Inherits="Sigesoft.Server.WebClientAdmin.UI.Auditar.FRM033D" %>
                 ...
                 <x:Panel ID="Panel4" Layout="Fit" runat="server" ShowBorder="false" ShowHeader="false" >
                    <Items>
                        ...
                        AutoScroll="true" runat="server" EnableCollapse="True" Height="180px" >                        
                            <Items>     
                                    <x:DropDownList ID="ddlReco" runat="server"  Label="Recomendación" Width="140px"></x:DropDownList>           
                            </Items>
                        </x:SimpleForm>
                    </Items>
                </x:Panel>
