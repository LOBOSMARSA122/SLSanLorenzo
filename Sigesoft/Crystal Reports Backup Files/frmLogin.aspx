...
body {
  ...
  color:white;
  font-size:12px;
  background:#d0eef2 url(/images/classy_fabric.png);
}
...
<body>
    <script language="JavaScript" type="text/javascript">
        TrustLogo("http://omeganet-medical.com:81/comodo_secure_seal_100x85_transp.png", "CL1", "none");
</script>
