...
namespace Sigesoft.Server.WebClientAdmin.BE
{
    ...
    public partial class calendarDto
    {
        ...
        [DataMember()]
        public String v_CalendarId_2 { get; set; }

        [DataMember()]
        public Nullable<DateTime> d_DateProgramming { get; set; }

        [DataMember()]
        public String v_PersonProgramming { get; set; }

        [DataMember()]
        public String v_ResponsableProgramming { get; set; }
        ...
        public calendarDto(String v_CalendarId, String v_PersonId, String v_ServiceId, Nullable<DateTime> d_DateTimeCalendar, Nullable<DateTime> d_CircuitStartDate, Nullable<DateTime> d_EntryTimeCM, Nullable<Int32> i_ServiceTypeId, Nullable<Int32> i_CalendarStatusId, Nullable<Int32> i_ServiceId, String v_ProtocolId, Nullable<Int32> i_NewContinuationId, Nullable<Int32> i_LineStatusId, Nullable<Int32> i_IsVipId, Nullable<Int32> i_IsDeleted, Nullable<Int32> i_InsertUserId, Nullable<DateTime> d_InsertDate, Nullable<Int32> i_UpdateUserId, Nullable<DateTime> d_UpdateDate, Nullable<DateTime> d_SalidaCM, String v_CalendarId_2, Nullable<DateTime> d_DateProgramming, String v_PersonProgramming, String v_ResponsableProgramming, personDto person, serviceDto service)
        {
			...
			this.v_CalendarId_2 = v_CalendarId_2;
			this.d_DateProgramming = d_DateProgramming;
			this.v_PersonProgramming = v_PersonProgramming;
			this.v_ResponsableProgramming = v_ResponsableProgramming;
			this.person = person;
