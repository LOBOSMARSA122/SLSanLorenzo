...
{
    public partial class FRM100 : System.Web.UI.Page
    {
        ...
        protected void fileDoc_FileSelected(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    fileDoc = null;
                    fileDoc.EmptyText = "Por favor seleccione un archivo";
        ...
        protected void ddlProtocoloId_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (ddlProtocoloId.SelectedValue.ToString() != "-1")
            {
                fileDoc.Enabled = true;
                Session["ProtocoloNombre"] = ddlProtocoloId.SelectedText.ToString();
            }
            else
            {
                fileDoc.Enabled = false;
                Session["ProtocoloNombre"] = null;
            }
        }
