...
{
    public partial class FRM031J : System.Web.UI.Page
    {
        ...
        private void link_Click(object sender, System.EventArgs e)
        {
            ...
            if (((ClientSession)Session["objClientSession"]).i_CurrentOrganizationId == 2)
            {
                path = rutaReportes + senderCtrl.ID.ToString() + "-CAPE.pdf";
            }
            else
            {
