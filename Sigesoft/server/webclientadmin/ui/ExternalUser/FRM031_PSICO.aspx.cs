...
{
    public partial class FRM031_PSICO : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            objLinkButton.Text = ListaServicios[0].Paciente + "-N002-ME000000033";
        ...
        private void link_Click(object sender, System.EventArgs e)
        {
            ...
            path = rutaReportes + senderCtrl.ID.ToString() + "-Psicologia.pdf";
