...
{
    public partial class FRMINTERC : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            objLinkButton.Text = ListaServicios[0].Paciente + "Interconsulta";
        ...
        private void link_Click(object sender, System.EventArgs e)
        {
            ...
            string rutaReportes = WebConfigurationManager.AppSettings["Interconsulta"];
         
            OperationResult objOperationResult = new OperationResult();
            LinkButton senderCtrl = (LinkButton)sender;
            string path;
            var name = ListaServicios[0].Paciente;
            path = rutaReportes + senderCtrl.ID.ToString() +"-"+ name + ".pdf";
