...
{
    public partial class FRM031M : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            objLinkButton.Text = ListaServicios[0].Paciente + "-Toxicológico";
        ...
        private void link_Click(object sender, System.EventArgs e)
        {
            ...
            path = rutaReportes + senderCtrl.ID.ToString() + "-N009-ME000000303.pdf";
