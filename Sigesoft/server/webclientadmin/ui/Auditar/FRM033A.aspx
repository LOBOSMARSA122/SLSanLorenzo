<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FRM033A.aspx.cs" Inherits="Sigesoft.Server.WebClientAdmin.UI.Auditar.FRM033A" %>
                 ...
                 <x:Panel ID="Panel4" Layout="Fit" runat="server" ShowBorder="false" ShowHeader="false" >
                    <Items>
                        ...
                        AutoScroll="true" runat="server" EnableCollapse="True" Height="180px" >                        
                            <Items>     
                                <x:DropDownList ID="ddlAptitud" runat="server"  Label="Aptitud." Width="140px"></x:DropDownList>         
                                <x:TextArea ID="txtComentario" Label="Comentario" runat="server" Text="" Width="140" Height="50"></x:TextArea>
                            </Items>
                        </x:SimpleForm>
                    </Items>
                </x:Panel>
