                                ...
                                <x:Panel ID="Panel9" Title="PREGUNTAS PARA TODOS LOS CANDIDATOS  A ESPIROMETRÍA (RELACIONADAS A CRITERIOS DE EXCLUSIÓN)" EnableBackgroundColor="true" Height="240px" runat="server"
                                    ...
                                    <Items> 
                                        <x:Panel ID="Panel10" Width="800px" Height="200px" EnableBackgroundColor="true"
                                            ...
                                            <Items>
                                                ...
                                                <x:Label ID="Label1" runat="server" Text="."></x:Label>
                                                 <x:TextBox ID="TextBox2" runat="server" Text="3. ¿HA TENIDO ALGÚN ATAQUE CARDÍACO O INFARTO AL CORAZÓN EN LOS ÚLTIMOS 3 MESES?" Width="790"></x:TextBox>
                                                <x:Label ID="Label2" runat="server" Text="."></x:Label>
                                                 <x:TextBox ID="TextBox3" runat="server" Text="4. ¿ESTÁ USANDO MEDICAMENTOS PARA LA TUBERCULOSIS, EN ESTE MOMENTO?" Width="790"></x:TextBox>
                                                <x:Label ID="Label3" runat="server" Text="."></x:Label>
                                                 <x:TextBox ID="TextBox4" runat="server" Text="5. EN CASO DE SER MUJER: ¿ESTÁ USTED EMBARAZADA ACTUALMENTE?" Width="790"></x:TextBox>
                                            </Items>
                                        </x:Panel>
                                        <x:Panel ID="Panel11" Width="160px" EnableBackgroundColor="true" runat="server"
                                            ...
                                            <Items>
                                                <x:DropDownList ID="ddlPre1" runat="server" Width="150"></x:DropDownList>                                               
                                                <x:Label ID="Label41" runat="server" Text="."></x:Label>
                                                 <x:DropDownList ID="ddlPre2" runat="server" Width="150"></x:DropDownList>                                               
                                                <x:Label ID="Label4" runat="server" Text="."></x:Label>
                                                 <x:DropDownList ID="ddlPre3" runat="server" Width="150"></x:DropDownList>                                               
                                                <x:Label ID="Label5" runat="server" Text="."></x:Label>
                                                 <x:DropDownList ID="ddlPre4" runat="server" Width="150"></x:DropDownList>                                               
                                                <x:Label ID="Label6" runat="server" Text="."></x:Label>
                                                 <x:DropDownList ID="ddlPre5" runat="server" Width="150"></x:DropDownList>                  
                                            </Items>
                                        </x:Panel>
                                    </Items>
                                </x:Panel>
                                <x:Panel ID="Panel1" Title="ANTECEDENTES MÉDICOS DE IMPORTANCIA" EnableBackgroundColor="true" Height="270px" runat="server"
                                    ...
                                    <Items> 
                                         <x:Panel ID="Panel3" Width="350px" Height="230px" EnableBackgroundColor="true"
                                            ...
                                            <Items>
                                                <x:TextBox ID="TextBox5" runat="server" Text="HEMOPTISIS" Width="340px"></x:TextBox>
                                                <x:Label ID="Label15" runat="server" Text="."></x:Label>
                                                <x:TextBox ID="TextBox6" runat="server" Text="PNEUMOTÓRAX" Width="340px"></x:TextBox>
                                                <x:Label ID="Label16" runat="server" Text="."></x:Label>
                                                <x:TextBox ID="TextBox7" runat="server" Text="TRAQUEOSTOMÍA" Width="340px"></x:TextBox>
                                                <x:Label ID="Label17" runat="server" Text="."></x:Label>
                                                <x:TextBox ID="TextBox8" runat="server" Text="SONDA PLEURAL" Width="340px"></x:TextBox>
                                                <x:Label ID="Label18" runat="server" Text="."></x:Label>
                                                <x:TextBox ID="TextBox9" runat="server" Text="ANEURISMAS CEREBRAL, ABDOMEN, TÓRAX" Width="340px"></x:TextBox>
                                                <x:Label ID="Label19" runat="server" Text="."></x:Label>
                                                <x:TextBox ID="TextBox10" runat="server" Text="EMBOLIA PULMONAR" Width="340px"></x:TextBox>
                                            </Items>
                                        </x:Panel>
                                        <x:Panel ID="Panel4" Width="130px" EnableBackgroundColor="true" runat="server"
                                            BodyPadding="5px" ShowBorder="true" ShowHeader="true" Height="230px" Title="SI / NO">
                                            <Items>
                                                <x:DropDownList ID="ddlhemoptisis" runat="server" Width="120"></x:DropDownList>                                               
                                                <x:Label ID="Label7" runat="server" Text="."></x:Label>
                                                <x:DropDownList ID="ddlpneumotorax" runat="server" Width="120"></x:DropDownList>                                               
                                                <x:Label ID="Label8" runat="server" Text="."></x:Label>
                                                <x:DropDownList ID="ddltraqueostomia" runat="server" Width="120"></x:DropDownList>                                               
                                                <x:Label ID="Label9" runat="server" Text="."></x:Label>
                                                <x:DropDownList ID="ddlsonda_pleural" runat="server" Width="120"></x:DropDownList>                                               
                                                <x:Label ID="Label10" runat="server" Text="."></x:Label>
                                                <x:DropDownList ID="ddlaneurisma_cerebral" runat="server" Width="120"></x:DropDownList>   
                                                <x:Label ID="Label20" runat="server" Text="."></x:Label>
                                                <x:DropDownList ID="ddlembolia_pulmonar" runat="server" Width="120"></x:DropDownList>                
                                            </Items>
                                        </x:Panel>
                                        <x:Panel ID="Panel5" Width="350px" Height="230px" EnableBackgroundColor="true"
                                            runat="server" BodyPadding="5px" ShowBorder="true" ShowHeader="true" Title="ANTECEDENTES">
                                            <Items>
                                                <x:TextBox ID="TextBox11" runat="server" Text="INFARTO RECIENTE" Width="340px"></x:TextBox>
                                                <x:Label ID="Label21" runat="server" Text="."></x:Label>
                                                <x:TextBox ID="TextBox12" runat="server" Text="INESTABILIDAD CV" Width="340px"></x:TextBox>
                                                <x:Label ID="Label22" runat="server" Text="."></x:Label>
                                                <x:TextBox ID="TextBox13" runat="server" Text="FIEBRE, NÁUSEA VÓMITO" Width="340px"></x:TextBox>
                                                <x:Label ID="Label23" runat="server" Text="."></x:Label>
                                                <x:TextBox ID="TextBox14" runat="server" Text="EMBARAZO AVANZADO" Width="340px"></x:TextBox>
                                                <x:Label ID="Label24" runat="server" Text="."></x:Label>
                                                <x:TextBox ID="TextBox15" runat="server" Text="EMBARAZO COMPLICADO" Width="340px"></x:TextBox>
                                            </Items>
                                        </x:Panel>
                                        <x:Panel ID="Panel6" Width="130px" EnableBackgroundColor="true" runat="server"
                                            BodyPadding="5px" ShowBorder="true" ShowHeader="true" Height="230px" Title="SI / NO">
                                            <Items>
                                                <x:DropDownList ID="ddlinfarto_reciente" runat="server" Width="120"></x:DropDownList>                                               
                                                <x:Label ID="Label11" runat="server" Text="."></x:Label>
                                                 <x:DropDownList ID="ddlinestabilidad_cv" runat="server" Width="120"></x:DropDownList>                                               
                                                <x:Label ID="Label12" runat="server" Text="."></x:Label>
                                                 <x:DropDownList ID="ddlfiebre_nausea" runat="server" Width="120"></x:DropDownList>                                               
                                                <x:Label ID="Label13" runat="server" Text="."></x:Label>
                                                 <x:DropDownList ID="ddlembarazo_avanzado" runat="server" Width="120"></x:DropDownList>                                               
                                                <x:Label ID="Label14" runat="server" Text="."></x:Label>
                                                 <x:DropDownList ID="ddlembarazo_complicado" runat="server" Width="120"></x:DropDownList>                  
                                            </Items>
                                        </x:Panel>
                                    </Items>
                                </x:Panel>
                                <x:Panel ID="Panel7" Title="PREGUNTAS PARA TODOS LOS ENTREVISTADOS QUE NO TIENEN LOS CRITERIOS DE EXCLUSIÓN Y QUE POR LO TANTO DEBEN HACER LA ESPIROMETRÍA." EnableBackgroundColor="true" Height="340px" runat="server"
                                    ...
                                    <Items> 
                                        <x:Panel ID="Panel8" Width="800px" Height="300px" EnableBackgroundColor="true"
                                            runat="server" BodyPadding="5px" ShowBorder="true" ShowHeader="true" Title="CUESTIONARIO">
                                            <Items>
                                                <x:TextBox ID="TextBox16" runat="server" Text="1. ¿TUVO UNA INFECCIÓN RESPIRATORIA (RESFRIADO), EN LAS ÚLTIMAS 3 SEMANAS?" Width="790"></x:TextBox>
                                                <x:Label ID="Label25" runat="server" Text="."></x:Label>
                                                <x:TextBox ID="TextBox17" runat="server" Text="2.¿TUVO INFECCIÓN EN EL OÍDO EN LAS ÚLTIMAS 3 SEMANAS?" Width="790"></x:TextBox>
                                                <x:Label ID="Label26" runat="server" Text="."></x:Label>
                                                <x:TextBox ID="TextBox18" runat="server" Text="3.¿USÓ AEROSOLES (SPRAYS INHALADOS) O NEBULIZACIONES CON BRONCODILATADORES, EN LAS ÚLTIMAS 3 HORAS?" Width="790"></x:TextBox>
                                                <x:Label ID="Label27" runat="server" Text="."></x:Label>
                                                <x:TextBox ID="TextBox19" runat="server" Text="4. ¿HA USADO ALGÚN MEDICAMENTO BRONCODILATADOR DURANTE LAS ÚLTIMAS 8 HORAS?" Width="790"></x:TextBox>
                                                <x:Label ID="Label28" runat="server" Text="."></x:Label>
                                                <x:TextBox ID="TextBox20" runat="server" Text="5.¿FUMÓ (CUALQUIER TIPO DE CIGARRO), EN LAS ÚLTIMAS DOS HORAS?" Width="790"></x:TextBox>
                                                <x:Label ID="Label33" runat="server" Text="."></x:Label>
                                                <x:TextBox ID="TextBox21" runat="server" Text="6.¿REALIZÓ ALGÚN EJERCICIO FÍSICO FUERTE (COMO GIMNASIA, CAMINATA O TROTAR), EN LA ÚLTIMA HORA?" Width="790"></x:TextBox>
                                        ...
                                        <x:Panel ID="Panel12" Width="160px" EnableBackgroundColor="true" runat="server"
                                            BodyPadding="5px" ShowBorder="true" ShowHeader="true" Height="300px" Title="SI / NO">
                                            <Items>
                                                <x:DropDownList ID="ddl1_tuvo_una_infeccion" runat="server" Width="150"></x:DropDownList>                                               
                                                <x:Label ID="Label29" runat="server" Text="."></x:Label>
                                                 <x:DropDownList ID="ddl2_tuvo_infeccion" runat="server" Width="150"></x:DropDownList>                                               
                                                <x:Label ID="Label30" runat="server" Text="."></x:Label>
                                                 <x:DropDownList ID="ddl3_uso_aerosoles" runat="server" Width="150"></x:DropDownList>                                               
                                                <x:Label ID="Label31" runat="server" Text="."></x:Label>
                                                 <x:DropDownList ID="ddl4_ha_usado_algun_medicamento" runat="server" Width="150"></x:DropDownList>                                               
                                                <x:Label ID="Label32" runat="server" Text="."></x:Label>
                                                 <x:DropDownList ID="ddl5_ha_fumado_cualquier" runat="server" Width="150"></x:DropDownList>    
                                                 <x:Label ID="Label60" runat="server" Text="."></x:Label>
                                                 <x:DropDownList ID="ddl6_realizo_algun_ejercicio" runat="server" Width="150"></x:DropDownList> 
                                                 <x:Label ID="Label61" runat="server" Text="."></x:Label>
                                                 <x:DropDownList ID="ddl7_ingirio_alimentos" runat="server" Width="150"></x:DropDownList>               
                                            </Items>
                                        </x:Panel>
                                    </Items>
                                </x:Panel>
                                <x:Panel ID="Panel13" Title="FUNCIÓN RESPIRATORIA ABS %" EnableBackgroundColor="true" Height="390px" runat="server"
                                    ...
                                    <Items> 
                                        <x:Panel ID="Panel14" Width="200px" Height="350px" EnableBackgroundColor="true"
                                            ...
                                            <Items>
                                                <x:TextBox ID="TextBox23" runat="server" Text="CVF" Width="790"></x:TextBox>
                                                <x:Label ID="Label35" runat="server" Text="."></x:Label>
                                                 <x:TextBox ID="TextBox24" runat="server" Text="VEF (1)" Width="790"></x:TextBox>
                                                <x:Label ID="Label36" runat="server" Text="."></x:Label>
                                                 <x:TextBox ID="TextBox25" runat="server" Text="VEF1 ÷ CVF" Width="790"></x:TextBox>
                                                <x:Label ID="Label37" runat="server" Text="."></x:Label>
                                                 <x:TextBox ID="TextBox26" runat="server" Text="FET" Width="790"></x:TextBox>
                                                <x:Label ID="Label38" runat="server" Text="."></x:Label>
                                                 <x:TextBox ID="TextBox27" runat="server" Text="FEF (25)(75)" Width="790"></x:TextBox>
                                                 <x:Label ID="Label39" runat="server" Text="."></x:Label>
                                                 <x:TextBox ID="TextBox28" runat="server" Text="PEF)" Width="790"></x:TextBox>
                                                 <x:Label ID="Label40" runat="server" Text="."></x:Label>
                                                 <x:TextBox ID="TextBox29" runat="server" Text="MEF " Width="790"></x:TextBox>
                                                 <x:Label ID="Label42" runat="server" Text="."></x:Label>
                                                 <x:TextBox ID="TextBox30" runat="server" Text="R (50) " Width="790"></x:TextBox>
                                                 <x:Label ID="Label43" runat="server" Text="."></x:Label>
                                                 <x:TextBox ID="TextBox31" runat="server" Text="MVV (IND)" Width="790"></x:TextBox>
                                            </Items>
                                        </x:Panel>
                                        <x:Panel ID="Panel15" Width="200px" Height="350px" EnableBackgroundColor="true"
                                            ...
                                            <Items>
                                                <x:TextBox ID="txtcvf" runat="server" Text="" Width="790"></x:TextBox>
                                                <x:Label ID="Label44" runat="server" Text="."></x:Label>
                                                 <x:TextBox ID="txtvef_1" runat="server" Text="" Width="790"></x:TextBox>
                                                <x:Label ID="Label45" runat="server" Text="."></x:Label>
                                                 <x:TextBox ID="txtvef1_cvf" runat="server" Text="" Width="790"></x:TextBox>
                                                <x:Label ID="Label46" runat="server" Text="."></x:Label>
                                                 <x:TextBox ID="txtfet" runat="server" Text="" Width="790"></x:TextBox>
                                                <x:Label ID="Label47" runat="server" Text="."></x:Label>
                                                 <x:TextBox ID="txtfef_2575" runat="server" Text="" Width="790"></x:TextBox>
                                                 <x:Label ID="Label48" runat="server" Text="."></x:Label>
                                                 <x:TextBox ID="txtpef" runat="server" Text="" Width="790"></x:TextBox>
                                                 <x:Label ID="Label49" runat="server" Text="."></x:Label>
                                                 <x:TextBox ID="txtmef" runat="server" Text=" " Width="790"></x:TextBox>
                                                 <x:Label ID="Label50" runat="server" Text="."></x:Label>
                                                 <x:TextBox ID="txtr_50" runat="server" Text="" Width="790"></x:TextBox>
                                                 <x:Label ID="Label51" runat="server" Text="."></x:Label>
                                                 <x:TextBox ID="txtmvv_ind" runat="server" Text="" Width="790"></x:TextBox>
                                            </Items>
                                        </x:Panel>
                                          <x:Panel ID="Panel16" Width="560px" Height="350px" EnableBackgroundColor="true"
                                            ...
                                            <Items>
                                                <x:TextBox ID="txtdescripcion_cvf" runat="server" Text="" Width="550"></x:TextBox>
                                                <x:Label ID="Label52" runat="server" Text="."></x:Label>
                                                 <x:TextBox ID="txtdescripcion_vef_1" runat="server" Text="" Width="550"></x:TextBox>
                                                <x:Label ID="Label53" runat="server" Text="."></x:Label>
                                                 <x:TextBox ID="txtdescripcion_vef1_cvf" runat="server" Text="" Width="550"></x:TextBox>
                                                <x:Label ID="Label54" runat="server" Text="."></x:Label>
                                                 <x:TextBox ID="txtdescripcion_fet" runat="server" Text="" Width="550"></x:TextBox>
                                                <x:Label ID="Label55" runat="server" Text="."></x:Label>
                                                 <x:TextBox ID="txtdescripcion_f_2575" runat="server" Text="" Width="550"></x:TextBox>
                                                 <x:Label ID="Label56" runat="server" Text="."></x:Label>
                                                 <x:TextBox ID="txtdescripcion_pef" runat="server" Text="" Width="550"></x:TextBox>
                                                 <x:Label ID="Label57" runat="server" Text="."></x:Label>
                                                 <x:TextBox ID="txtdescripcion_mef" runat="server" Text=" " Width="550"></x:TextBox>
                                                 <x:Label ID="Label58" runat="server" Text="."></x:Label>
                                                 <x:TextBox ID="txtdescripcion_r_50" runat="server" Text="" Width="550"></x:TextBox>
                                                 <x:Label ID="Label59" runat="server" Text="."></x:Label>
                                                 <x:TextBox ID="txtdescripcion_mvvind" runat="server" Text="" Width="550"></x:TextBox>
                                            </Items>
                                        </x:Panel>
                                    </Items>
                                </x:Panel>
