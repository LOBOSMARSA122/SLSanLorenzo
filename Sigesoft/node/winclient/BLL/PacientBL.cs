                ...
                using (SigesoftEntitiesModel dbContext = new SigesoftEntitiesModel())
                {
                    ...
                    var sql = (from a in objEntity.ToList()
                               ...
                               select new MatrizShauindo
                               {
                                   ...
                                   Vef1 = varValores.Find(p => p.ServicioId == a.ServiceId).CampoValores.Find(o => o.IdCampo == "N002-MF000000287") == null ? " " : varValores.Find(p => p.ServicioId == a.ServiceId).CampoValores.Find(o => o.IdCampo == "N002-MF000000287").Valor,
