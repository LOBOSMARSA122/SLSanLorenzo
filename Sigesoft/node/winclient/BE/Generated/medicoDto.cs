...
namespace Sigesoft.Node.WinClient.BE
{
    ...
    public partial class medicoDto
    {
        ...
        public medicoDto(String v_MedicoId, Nullable<Int32> i_MasterServiceId, Nullable<Int32> i_SystemUserId, Nullable<Int32> i_MasterServiceTypeId, Nullable<Decimal> r_Clinica, Nullable<Decimal> r_Medico, Nullable<Int32> i_CategoryId, Nullable<Decimal> r_Price, Nullable<Int32> i_IsDeleted, String v_EmployerOrganizationId, String v_CustomerOrganizationId, String v_WorkingOrganizationId, Nullable<Int32> i_InsertUserId, Nullable<DateTime> d_InsertDate, Nullable<Int32> i_UpdateUserId, Nullable<DateTime> d_UpdateDate)
        {
