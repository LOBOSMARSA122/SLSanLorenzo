...
namespace Sigesoft.Node.WinClient.BE
{
    ...
    public partial class ticketDto
    {
        ...
        public ticketDto(String v_TicketId, String v_ServiceId, Nullable<DateTime> d_Fecha, Nullable<Int32> i_TipoCuentaId, Nullable<Int32> i_ConCargoA, Nullable<Int32> i_IsDeleted, Nullable<Int32> i_InsertUserId, Nullable<DateTime> d_InsertDate, Nullable<Int32> i_UpdateUserId, Nullable<DateTime> d_UpdateDate, List<ticketdetalleDto> ticketdetalle)
        {
