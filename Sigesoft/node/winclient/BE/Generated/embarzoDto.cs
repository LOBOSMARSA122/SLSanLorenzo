...
namespace Sigesoft.Node.WinClient.BE
{
    ...
    public partial class embarzoDto
    {
        ...
        [DataMember()]
        public adultomayorDto adultomayor { get; set; }

        public embarzoDto()
        {
        }

        public embarzoDto(String v_EmbarazoId, String v_AdultoMayorId, String v_Anio, String v_Cpn, String v_Complicacion, String v_Parto, String v_PesoRn, String v_Puerpio, Nullable<Int32> i_IsDeleted, Nullable<Int32> i_InsertUserId, Nullable<DateTime> d_InsertDate, Nullable<Int32> i_UpdateUserId, Nullable<DateTime> d_UpdateDate, adultomayorDto adultomayor)
        {
