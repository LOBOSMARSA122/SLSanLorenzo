...
namespace Sigesoft.Node.WinClient.BE
{
    ...
    public partial class protocolDto
    {
        ...
        [DataMember()]
        public Nullable<Single> r_PriceFactor { get; set; }

        [DataMember()]
        public Nullable<Single> r_HospitalBedPrice { get; set; }

        [DataMember()]
        public Nullable<Single> r_MedicineDiscount { get; set; }
