...
namespace Sigesoft.Node.WinClient.BE
{
    ...
    public partial class gerenciatipopagoResultDto
    {
        ...
        public gerenciatipopagoResultDto(Nullable<Int32> idCondicionPago, String condicionPago, Nullable<Int32> idFormaPago, String formaPago, Nullable<DateTime> fechaFactura, String comprobante, Nullable<DateTime> fechaFactura1, String empresa, Nullable<Decimal> importe, String serviceId, String trabajador, Nullable<DateTime> fechaServicio, String compania, String contratista, Nullable<Double> costoExamen, String tipoEso)
        {
