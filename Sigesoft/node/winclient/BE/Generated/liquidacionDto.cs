...
namespace Sigesoft.Node.WinClient.BE
{
    ...
    public partial class liquidacionDto
    {
        ...
        public liquidacionDto(String v_LiquidacionId, String v_NroLiquidacion, String v_ServiceId, String v_OrganizationId, Nullable<Decimal> d_Monto, Nullable<DateTime> d_FechaVencimiento, String v_NroFactura, Nullable<Int32> i_IsDeleted, Nullable<Int32> i_InsertUserId, Nullable<DateTime> d_InsertDate, Nullable<Int32> i_UpdateUserId, Nullable<DateTime> d_UpdateDate, organizationDto organization, serviceDto service)
        {
