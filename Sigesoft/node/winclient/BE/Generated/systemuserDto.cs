...
namespace Sigesoft.Node.WinClient.BE
{
    ...
    public partial class systemuserDto
    {
        ...
        public systemuserDto(Int32 i_SystemUserId, String v_PersonId, String v_UserName, String v_Password, String v_SecretQuestion, String v_SecretAnswer, Nullable<DateTime> d_ExpireDate, Nullable<Int32> i_IsDeleted, Nullable<Int32> i_InsertUserId, Nullable<DateTime> d_InsertDate, Nullable<Int32> i_UpdateUserId, Nullable<DateTime> d_UpdateDate, Nullable<Int32> i_SystemUserTypeId, Nullable<Int32> i_RolVentaId, String v_SystemUserByOrganizationId, List<protocolsystemuserDto> protocolsystemuser, List<restrictedwarehouseprofileDto> restrictedwarehouseprofile, personDto person, List<systemusergobalprofileDto> systemusergobalprofile, List<systemuserrolenodeDto> systemuserrolenode)
        {
