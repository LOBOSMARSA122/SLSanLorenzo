...
namespace Sigesoft.Node.WinClient.BE
{
    ...
    public partial class ticketdetalleDto
    {
        ...
        public ticketdetalleDto(String v_TicketDetalleId, String v_TicketId, String v_Descripcion, String v_IdProductoDetalle, String v_CodInterno, Nullable<Decimal> d_Cantidad, Nullable<Decimal> d_PrecioVenta, Nullable<Int32> i_EsDespachado, Nullable<Int32> i_IsDeleted, Nullable<Int32> i_InsertUserId, Nullable<DateTime> d_InsertDate, Nullable<Int32> i_UpdateUserId, Nullable<DateTime> d_UpdateDate, ticketDto ticket)
        {
