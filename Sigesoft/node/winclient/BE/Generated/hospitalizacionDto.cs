...
namespace Sigesoft.Node.WinClient.BE
{
    ...
    public partial class hospitalizacionDto
    {
        ...
        [DataMember()]
        public List<hospitalizacionhabitacionDto> hospitalizacionhabitacion { get; set; }
        ...
        public hospitalizacionDto(String v_HopitalizacionId, String v_PersonId, Nullable<DateTime> d_FechaIngreso, Nullable<DateTime> d_FechaAlta, Nullable<Int32> i_IsDeleted, Nullable<Int32> i_InsertUserId, Nullable<DateTime> d_InsertDate, Nullable<Int32> i_UpdateUserId, Nullable<DateTime> d_UpdateDate, List<hospitalizacionhabitacionDto> hospitalizacionhabitacion, List<hospitalizacionserviceDto> hospitalizacionservice)
        {
			...
			this.hospitalizacionhabitacion = hospitalizacionhabitacion;
