...
namespace Sigesoft.Node.WinClient.BE
{
    ...
    public partial class hospitalizacionhabitacionDto
    {
        ...
        public hospitalizacionhabitacionDto(String v_HospitalizacionHabitacionId, String v_HopitalizacionId, Nullable<Int32> i_HabitacionId, Nullable<DateTime> d_StartDate, Nullable<DateTime> d_EndDate, Nullable<Int32> i_IsDeleted, Nullable<Int32> i_InsertUserId, Nullable<DateTime> d_InsertDate, Nullable<Int32> i_UpdateUserId, Nullable<DateTime> d_UpdateDate)
        {
