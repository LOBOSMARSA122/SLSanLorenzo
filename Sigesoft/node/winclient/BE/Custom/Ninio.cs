...
namespace Sigesoft.Node.WinClient.BE
{
    public class Ninio
    {
        ...
        public string i_TipoAfiliacionPadre { get; set; }
        public string v_CodigoAfiliacionPadre { get; set; }
        public string i_GradoInstruccionPadre { get; set; }
        public string v_OcupacionPadre { get; set; }
        public string i_EstadoCivilIdPadre { get; set; }
        ...
        public string i_TipoAfiliacionMadre { get; set; }
        public string v_CodigoAfiliacionMadre { get; set; }
        public string i_GradoInstruccionMadre { get; set; }
        public string v_OcupacionMadre { get; set; }
        public string i_EstadoCivilIdMadre1 { get; set; }
