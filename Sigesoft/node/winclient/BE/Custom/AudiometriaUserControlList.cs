...
namespace Sigesoft.Node.WinClient.BE
{
    public class AudiometriaUserControlList
    {
        ...
        public string EM_OD_125 { get; set; }
        public string EM_OD_250 { get; set; }
        public string EM_OD_500 { get; set; }
        public string EM_OD_1000 { get; set; }
        public string EM_OD_2000 { get; set; }
        public string EM_OD_3000 { get; set; }
        public string EM_OD_4000 { get; set; }
        public string EM_OD_6000 { get; set; }
        public string EM_OD_8000 { get; set; }
        ...
        public string EM_OI_125 { get; set; }
        public string EM_OI_250 { get; set; }
        public string EM_OI_500 { get; set; }
        public string EM_OI_1000 { get; set; }
        public string EM_OI_2000 { get; set; }
        public string EM_OI_3000 { get; set; }
        public string EM_OI_4000 { get; set; }
