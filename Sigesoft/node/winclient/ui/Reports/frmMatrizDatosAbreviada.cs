...
{
    public partial class frmMatrizDatosAbreviada : Form
    {
        ServiceBL _serviceBL = new ServiceBL();
        string strFilterExpression;

        public frmMatrizDatosAbreviada()
        {
            InitializeComponent();
        }

        private void frmMatrizDatosAbreviada_Load(object sender, EventArgs e)
        {
        ...
        private void btnFilter_Click(object sender, EventArgs e)
        {
            using (new LoadingClass.PleaseWait(this.Location, "Generando..."))
            {
                ...
                var objData = _serviceBL.ReporteAseguradoraAbreviada(pdatBeginDate, pdatEndDate, ddlCustomerOrganization.SelectedValue.ToString(), strFilterExpression);
