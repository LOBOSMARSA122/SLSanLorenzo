...
namespace Sigesoft.Node.WinClient.UI.Reports {
    ...
    public class PsicologicoMedSalud_SC_ING : ReportClass {
        
        public PsicologicoMedSalud_SC_ING() {
        }
        
        public override string ResourceName {
            get {
                return "PsicologicoMedSalud_SC_ING.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "Sigesoft.Node.WinClient.UI.Reports.PsicologicoMedSalud_SC_ING.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedPsicologicoMedSalud_SC_ING : Component, ICachedReport {
        
        public CachedPsicologicoMedSalud_SC_ING() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            PsicologicoMedSalud_SC_ING rpt = new PsicologicoMedSalud_SC_ING();
            rpt.Site = this.Site;
            return rpt;
        }
