...
namespace Sigesoft.Node.WinClient.UI.Reports
{
    public partial class frmManagementReportAsync : Form
    {
        ...
        public frmManagementReportAsync(string organizationId, string serviceId, string pacientId)
        {
            InitializeComponent();
        ...
        private void frmManagementReportAsync_Load(object sender, EventArgs e)
        {
            ...
            var oOrganizationBL = new OrganizationBL();
            var listaOrdenada = new List<ServiceComponentList>();
            ...
            var serviceComponents = serviceBL.GetServiceComponentsForManagementReport(_serviceId);
            if (listaOrdenReportes.Count > 0)
            {
                foreach (var item in listaOrdenReportes)
                {
                    var oServiceComponentList = new ServiceComponentList();
        ...
        public void ChooseReport(string componentId, string serviceId, int pintIdCrystal)
        {
