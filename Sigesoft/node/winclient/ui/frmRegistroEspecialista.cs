...
{
    public partial class frmRegistroEspecialista : Form
    {
        ...
        public frmRegistroEspecialista()
        {
            InitializeComponent();
        }
        ...
        private void btnIngresar_Click(object sender, EventArgs e)
        {
            try
            {
                if (uvComponent.Validate(true, false).IsValid)
                {
                    ...
                    frmEspecialista frm = new frmEspecialista(_CategoriaId);
                    frm._componentIds = _componentIds;
                    frm.ShowDialog();
                }
                else
        ...
        private void frmRegistroEspecialista_Load(object sender, EventArgs e)
        {
        ...
        private void ddlComponentId_SelectedValueChanged(object sender, EventArgs e)
        {
            ...
            _CategoriaId = int.Parse(eee.Value4.ToString());
