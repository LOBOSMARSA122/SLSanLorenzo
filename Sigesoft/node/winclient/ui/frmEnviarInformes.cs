...
{
    public partial class frmEnviarInformes : Form
    {
        ...
        public frmEnviarInformes(List<string> ListaServicioIds, string pEmpresaCliente, string FechaInicio, string FechaFin)
        {
            InitializeComponent();
        ...
        private void backgroundWorker1_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            try
            {
                ...
                ArchivoAdjunto.Add(ruta + "Informes " + EmpresaCliente + ".pdf");
